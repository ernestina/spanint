...
/*
define('DB_NAME', 'DEVSPANDB');
define('DB_TNS', '(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=192.168.137.1)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=DEVSPANDB)(INSTANCE_NAME= DEVSPANDB)))');
define('DB_USER', 'USRAPL14');
define('DB_PASS', 'Ter53r@h'); 
*/
