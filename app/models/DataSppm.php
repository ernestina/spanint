...
class DataSppm {
	...
	public function get_sp2d_rekap($filter) {
		...
		$sql = "SELECT DECODE(BANK_ACCOUNT_NAME,'MDRI','MANDIRI',
				...
				MAX (GAJI) GAJI, MAX (NON_GAJI) NON_GAJI, MAX (RETUR) RETUR, MAX (VOID) VOID, SUM(NILAI_GAJI) NILAI_GAJI, SUM(NILAI_NON_GAJI) NILAI_NON_GAJI, SUM(NILAI_RETUR) NILAI_RETUR,  SUM(NILAI_VOID) NILAI_VOID FROM (
				SELECT BANK_ACCOUNT_NAME, SUM(JUMLAH_SP2D) GAJI, NULL NON_GAJI, NULL RETUR, NULL VOID, NILAI_SP2D AS NILAI_GAJI , NULL AS NILAI_NON_GAJI , NULL AS NILAI_RETUR , NULL AS NILAI_VOID FROM REKAPITULASI_SP2D WHERE JENDOK = '1' ".$sql_tgl." GROUP BY BANK_ACCOUNT_NAME, JENDOK, NILAI_SP2D  
				UNION
				SELECT BANK_ACCOUNT_NAME, NULL GAJI, SUM(JUMLAH_SP2D) NON_GAJI, NULL RETUR, NULL VOID, NULL AS NILAI_GAJI , NILAI_SP2D AS NILAI_NON_GAJI , NULL AS NILAI_RETUR , NULL AS NILAI_VOID FROM REKAPITULASI_SP2D WHERE JENDOK = '2' ".$sql_tgl." GROUP BY BANK_ACCOUNT_NAME, JENDOK, NILAI_SP2D 
				UNION
				SELECT BANK_ACCOUNT_NAME, NULL GAJI, NULL NON_GAJI, SUM(JUMLAH_SP2D) RETUR, NULL VOID, NULL AS NILAI_GAJI , NULL AS NILAI_NON_GAJI , NILAI_SP2D AS NILAI_RETUR , NULL AS NILAI_VOID FROM REKAPITULASI_SP2D WHERE JENDOK = '3' ".$sql_tgl." GROUP BY BANK_ACCOUNT_NAME, JENDOK, NILAI_SP2D 
				UNION
				SELECT BANK_ACCOUNT_NAME, NULL GAJI, NULL NON_GAJI, NULL RETUR, SUM(JUMLAH_SP2D) VOID, NULL AS NILAI_GAJI , NULL AS NILAI_NON_GAJI , NULL AS NILAI_RETUR , NILAI_SP2D AS NILAI_VOID FROM REKAPITULASI_SP2D WHERE JENDOK = '4' ".$sql_tgl." GROUP BY BANK_ACCOUNT_NAME, JENDOK, NILAI_SP2D
