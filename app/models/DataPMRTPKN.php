...
class DataPMRTPKN {
    ...
    private $_table2 = 'SPAN_PMRT_PKN2';
    private $_table3 = 'SPAN_PMRT_PKN1';
    public $registry;
    ...
    public function get_pmrt_pkn_filter($filter) {
       /* $sql = "SELECT KDKPPN,AKUN,
        ...
        $sql = "SELECT 
				...
				AND
				(JML_SPM_DLM_PROSES_16 + NILAI_SPM_DLM_PROSES_16 + JML_SPM_DITERIMA_17 + NILAI_SPM_DITERIMA_17 + JML_SPM_DITERBITKAN_17 + JML_SPM_DLM_PROSES_17 +
				JML_SPM_DITERIMA_18 + NILAI_SPM_DITERIMA_18 + JML_SPM_DITERBITKAN_18 + NILAI_SPM_DITERBITKAN_18 + JML_SPM_DLM_PROSES_18 + NILAI_SPM_DLM_PROSES_18 +
				JML_SPM_DITERIMA_19 + NILAI_SPM_DITERIMA_19 + JML_SPM_DITERBITKAN_19 + NILAI_SPM_DITERBITKAN_19 + JML_SPM_DLM_PROSES_19 + NILAI_SPM_DLM_PROSES_19)
				> 0
				";
    ...
    public function get_pmrt_pkn_nihil_filter($filter) {
        $sql = "SELECT 
				...
				and (JML_SPM_DLM_PROSES_16 + NILAI_SPM_DLM_PROSES_16 + JML_SPM_DITERIMA_17 + NILAI_SPM_DITERIMA_17 + JML_SPM_DITERBITKAN_17 + JML_SPM_DLM_PROSES_17 +
				JML_SPM_DITERIMA_18 + NILAI_SPM_DITERIMA_18 + JML_SPM_DITERBITKAN_18 + NILAI_SPM_DITERBITKAN_18 + JML_SPM_DLM_PROSES_18 + NILAI_SPM_DLM_PROSES_18 +
				JML_SPM_DITERIMA_19 + NILAI_SPM_DITERIMA_19 + JML_SPM_DITERBITKAN_19 + NILAI_SPM_DITERBITKAN_19 + JML_SPM_DLM_PROSES_19 + NILAI_SPM_DLM_PROSES_19)
				> 0
