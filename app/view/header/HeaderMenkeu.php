<ul>
    ...
    <li class="nav"><h4><a href="<?php echo URL; ?>DataLRA/DataLRA"><span class="glyphicon glyphicon-dashboard"></span>&nbsp;&nbsp;Data Realisasi APBN</a></h4></li>
    <li class="subnav"><h4><span class="glyphicon glyphicon-gbp"></span>&nbsp;&nbsp;Data Ketersediaan Dana  <br><i>(Fund Available)</i></h4>
        <div class="collapse">
            <ul>
                ...
                <li><a href="<?php echo URL; ?>BA_ES1/DataRealisasiOutputBA">Per Output</a></li>                                     <li><a href="<?php echo URL; ?>BA_ES1/DataFaBaPerJenbel">Per Jenis Belanja</a></li>
                <li><a href="<?php echo URL; ?>BA_ES1/DataFaBaPerSdana">Per Sumber Dana</a></li>
                <li><a href="<?php echo URL; ?>BA_ES1/DataFaBaEs1Jenbel">Per BA - Jenis Belanja</a></li>
                <li><a href="<?php echo URL; ?>BA_ES1/DataFaBaEs1Sdana">Per BA - Sumber Dana</a></li>
            </ul>
        </div>
    </li>
    ...
    <li class="subnav"><h4><span class="glyphicon glyphicon-log-in"></span>&nbsp;&nbsp;Informasi Pendapatan</h4>
        <div class="collapse">
            <ul>
                ...
                <li><a href="<?php echo URL; ?>BA_ES1/DataRealisasiPenerimaanPerES1">Realisasi Pendapatan Per K/L</a></li>
