    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-10 col-md-6 col-sm-12">
                <h2>Realisasi Belanja per Sumber Dana</h2>
            </div>
...
//Development History.Revisi : 0 Kegiatan :1.mencetak hasil filter ke dalam pdf Dibuat oleh : Rifan Abdul Rachman Tanggal dibuat : 18-07-2014  File yang diubah : fund_fail.php  
        ...
        if (isset($this->lokasi)) {
			...
			?>
            <a href="<?php echo URL; ?>PDF/DataRealisasiSumberDanaBAES1_BAES1_PDF/<?php echo $kdlokasi; ?>/PDF" style="width: 100%" class="btn btn-default"><span class="glyphicon glyphicon-print"></span> PDF</a>
			</div><div class="col-lg-1 col-md-3 col-sm-12" style="padding-top: 10px;">
			<a href="<?php echo URL; ?>PDF/DataRealisasiSumberDanaBAES1_BAES1_PDF/<?php echo $kdlokasi; ?>/XLS" style="width: 100%" class="btn btn-default"><span class="glyphicon glyphicon-print-xls"></span> XLS</a>
			<?php
