            ...
            <div id="top">	
                <form method="POST" action="cekSupplier" enctype="multipart/form-data">
                   ...
                   echo "selected";
                    ...
                    <input type="number" name="nrs" id="nrs" size="15" value="<?php if (isset($this->d_nrs)) {
                   echo $this->d_nrs;
               } ?>">

                    <div id="wnamasupplier" class="error"></div>
                    <label class="isian">Nama Supplier: </label>
                    <input type="text" name="namasupplier" id="namasupplier" value="<?php if (isset($this->d_namasupplier)) {
                   echo $this->d_namasupplier;
               } ?>">

                    <div id="wnpwpsupplier" class="error"></div>
                    <label class="isian">NPWP Supplier: </label>
                    <input type="text" name="npwpsupplier" id="npwpsupplier" value="<?php if (isset($this->d_npwpsupplier)) {
                   echo $this->d_npwpsupplier;
               } ?>">

                    <div id="wnip" class="error"></div>
                    <label class="isian">NIP Penerima: </label>
                    <input type="number" name="nip" id="nip" size="18" value="<?php if (isset($this->d_nip)) {
                   echo $this->d_nip;
               } ?>">

                    <div id="wnamapenerima" class="error"></div>
                    <label class="isian">Nama Penerima: </label>
                    <input type="text" name="namapenerima" id="namapenerima" value="<?php if (isset($this->d_namapenerima)) {
                   echo $this->d_namapenerima;
               } ?>">

                    <div id="wnorek" class="error"></div>
                    <label class="isian">Nomor Rek.: </label>
                    <input type="text" name="norek" id="norek" value="<?php if (isset($this->d_norek)) {
        echo $this->d_norek;
    } ?>">

                    <div id="wnamarek" class="error"></div>
                    <label class="isian">Nama Rek.: </label>
                    <input type="text" name="namarek" id="namarek" value="<?php if (isset($this->d_namarek)) {
        echo $this->d_namarek;
    } ?>">

                    <div id="wnpwppenerima" class="error"></div>
                    <label class="isian">NPWP Penerima: </label>
                    <input type="text" name="npwppenerima" id="npwppenerima" value="<?php if (isset($this->d_npwppenerima)) {
