...
//Development History.Revisi : 0 Kegiatan :1.mencetak hasil filter ke dalam pdf Dibuat oleh : Rifan Abdul Rachman Tanggal dibuat : 18-07-2014  File yang diubah : droping.php  
    ...
    <ul class="inline" style="float: right"><li>
            <a href="<?php echo URL; ?>PDF/monitoringDroping_PDF/<?php echo $kdbank . "/" .$kdtgl_awal . "/" . $kdtgl_akhir; ?>" class="warning"><i class="icon icon-file icon-white"></i>PDF</a></li>							
        <?php
//----------------------------------------------------		
                ...
                if (isset($this->data)) {
                    if (empty($this->data)) {
                        ...
                        foreach ($this->data as $value) {
                            ...
                            if ($selisih < 0) {
                                echo "<td>Kurang Droping</td>";
                            } else if ($selisih > 0) {
                                echo "<td>Lebih Droping</td>";
                            } else {
                                echo "<td></td>";
                            };
                            echo "</tr>	";
