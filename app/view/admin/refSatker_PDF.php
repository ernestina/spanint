...
class FPDF_AutoWrapTable extends PDF_Rotate {
    ...
    public function rptDetailData() {
        ...
        $this->Cell($ukuran_kolom3, $h, 'NAMA BAGIAN ANGGARAN / Eselon 1 / Satuan Kerja', 1, 0, 'C', true);
        $px1 = $this->GetX();
        ...
        $py2 = $py1;
        $this->SetXY($px2, $py2);
        $this->Cell($ukuran_kolom2, $h, 'Kode KPPN', 1, 1, 'C', true);
        $this->SetX($px2 += $ukuran_kolom2);
        $this->Ln(3);
