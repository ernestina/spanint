    ...
    <table class="footable">
        ...
        <thead>
            <tr>
                ...
                <th class="align-left">NAMA BAGIAN ANGGARAN / Eselon 1 / Satuan Kerja </th>
                <th class="align-left">Kode KPPN</th>
                ...
                <?php foreach ($this->data as $value) { ?>
                    ...
                    <tr>
                        <td class="align-center"
                            <?php if (substr($value->get_kdakun(), 6, 1) == null) {
                            echo 'style="background:#FFC2C2"';
                        }?>><?php echo $no++; ?></td>
                        <td class="align-left"
                            <?php if (substr($value->get_kdakun(), 6, 1) == null) {
                            echo 'style="background:#FFC2C2"';
                        }?>><?php echo $value->get_kdakun(); ?></td>
                        <td class="align-left"
                            <?php if (substr($value->get_kdakun(), 6, 1) == null) {
                            echo 'style="background:#FFC2C2"';
                        }?>><?php echo $value->get_nmakun(); ?></td>
                        <td class="align-center"
                            <?php if (substr($value->get_kdakun(), 6, 1) == null) {
                            echo 'style="background:#FFC2C2"';
                        }?>><?php echo $value->get_kdkppn(); ?></td>
                    </tr>
        ...
        <div class="modal-content">
            ...
            <form id="filter-form" method="POST" action="<?php echo $this->action;?>" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <label class="isian"><?php echo $this->carikode ?> </label>
