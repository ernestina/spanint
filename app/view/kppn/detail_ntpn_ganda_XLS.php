...
//p8
$objPHPExcel->getActiveSheet()->setCellValue('H4', "Norek Persepsi");
//p9
$objPHPExcel->getActiveSheet()->setCellValue('I4', "Nomor Batch");
//p10
$objPHPExcel->getActiveSheet()->setCellValue('J4', "Nilai");
...
if (count($this->data) == 0) {
	...
	$nil['p3']=$value->get_segment1();
	$nil['p4']=$value->get_segment2();
	$nil['p5']=$value->get_segment3();
	$nil['p6']=$value->get_file_name();
	$nil['p7']=$value->get_status();
	$nil['p8']=$value->get_bank_account_num();	
	$nil['p9']=$value->get_gr_batch_num();
	if ($value->get_amount()==0){
		$nil['p10']='0';
	}else{
		$nil['p10']=$value->get_amount();
	}
