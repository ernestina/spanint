                ...
                <div class="btn-group-sm">
                    <button type="button" class="btn btn-default dropdown-toggle fullwidth" data-toggle="dropdown" aria-expanded="false"><span class="glyphicon glyphicon-print"></span>&nbsp; Cetak <span class="caret"></span>
                          ...
                          <ul class="dropdown-menu" role="menu">
                            <li><a href="<?php echo URL; ?>PDF/daftarsp2d_PDF/<?php echo $satker . "/" . $kdtgl_awal . "/" . $kdtgl_akhir . "/" . $jendok . "/" . $check_number . "/" . $invoice . "/" . $JenisSP2D . "/" . $JenisSPM; ?>/PDF">PDF</a></li>
                            <li><a href="<?php echo URL; ?>PDF/daftarsp2d_PDF/<?php echo $satker . "/" . $kdtgl_awal . "/" . $kdtgl_akhir . "/" . $jendok . "/" . $check_number . "/" . $invoice . "/" . $JenisSP2D . "/" . $JenisSPM; ?>/XLS">EXCEL</a></li>
                          </ul>
                </div>
            ...
            if (isset($this->data)) {
                if (empty($this->data)) {
                    ...
                    foreach ($this->data as $value) {
						...
						if (Session::get('role') == ADMIN or Session::get('role') == KANWIL or Session::get('role') == KPPN) {
