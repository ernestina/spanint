...
<div class="main-window-segment" style="padding-top: none; padding-bottom: 20px;">
    ...
    <a href="<?php echo URL; ?>PDF/sp2dSudahVoid_PDF/<?php echo $kdkppn . "/" . $kdtgl_awal . "/" . $kdtgl_akhir . "/" . $kdbank; ?>" style="width: 100%" class="btn btn-default"><span class="glyphicon glyphicon-print"></span> PDF</a>
