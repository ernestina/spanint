...
class FPDF_AutoWrapTable extends FPDF {
    ...
    public function rptDetailData() {
        ...
        $ukuran_kolom_tgl_selsp2d = 30;
        $ukuran_kolom_tgl_sp2d = 90;
		$kolom_grandtotal1=$ukuran_kolom_tgl_selsp2d+
		$ukuran_kolom_tgl_sp2d+$ukuran_kolom_satker+
		$ukuran_kolom_dana1+$ukuran_kolom_dana;

        $this->SetFillColor(200, 200, 200);
        $left = $this->GetX();
        $this->Cell($ukuran_kolom_tgl_selsp2d, $h, 'No', 1, 0, 'C', true);
        $px1 = $this->GetX();
        ...
        $py2 = $py1;
        $this->SetXY($px2, $py2);
        $this->Cell($ukuran_kolom_tgl_sp2d, $h, 'Tanggal Penerimaan', 1, 0, 'C', true);
        $this->SetX($px2 += $ukuran_kolom_tgl_sp2d);
        $this->Cell($ukuran_kolom_satker, $h, 'Nama', 1, 0, 'C', true);
        $this->SetX($px2 += $ukuran_kolom_satker);
        $this->Cell($ukuran_kolom_dana1, $h, 'Bagan Akun SPAN', 1, 0, 'C', true);
            ...
            foreach ($this->data as $value) {
                $this->Row(
                        array($no++,
                            $value->get_gl_date(),
                            $value->get_resp_name(),
                            $value->get_segment1(). "." .$value->get_segment2(). "." .$value->get_segment3()."." .$value->get_segment4(). "." .$value->get_segment5(). "." .$value->get_segment6(). "." .$value->get_segment7(). "." .$value->get_segment8(). "." .$value->get_segment9(). "." .$value->get_segment10(). "." .$value->get_segment11(). "." .$value->get_segment12(),
                            $value->get_mata_uang(),
...
//--------------------------
//pilihan
$judul = 'Laporan Suspend Akun Penerimaan'; //judul file laporan
$tipefile = '.pdf';
