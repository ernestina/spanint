...
/* //----------------------------------------------------
  ...
  //File yang ditambah : detailSp2dRekap_PDF.php
...
class FPDF_AutoWrapTable extends FPDF {
    ...
    public function rptDetailData() {
       ...
       if (substr(trim($nm_kppn), 0, 4) == 'KPPN') { //3
        ...
        $ukuran_kolom_tgl_selsp2d = 80;
        $ukuran_kolom_tgl_sp2d = 45;
		$kolom_grandtotal1=30+$ukuran_kolom_tgl_selsp2d+
		$ukuran_kolom_tgl_sp2d+$ukuran_kolom_satker+$ukuran_kolom_akun;
        ...
        $this->SetAligns(array('C', 'C', 'C', 'C', 'C', 'R', 'C', 'L'));
...
//--------------------------
//pilihan
$judul = 'Laporan Detail SP2D'; //judul file laporan
$tipefile = '.pdf';
