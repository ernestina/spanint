...
//-------------------------------------
	...
	$px1 = $this->GetX();
	$this->SetX($left+50); 
	$this->MultiCell(0, $h/2, 'Laporan Hold Invoice');
	$py1 = $this->GetY();
	$px2 = $px1;
	$py2 = $py1;
	$this->SetXY($px2,$py2);
	...
	$this->SetX($left += $ukuran_kolom_dana); $this->Cell($ukuran_kolom_pagu_total, $h, 'Uraian', 1, 0, 'C',true);
	$px1 = $this->GetX();
	...
	$py2 = $py1;
	$this->SetXY($px2,$py2);
	$this->Cell($ukuran_kolom_jenis_belanja, $h, 'Alasan Hold', 1, 0, 'C',true);
	$this->SetX($px2 += $ukuran_kolom_jenis_belanja);
	$this->Cell($ukuran_kolom_satker, $h, 'Status Release', 1, 0, 'C',true);
	$this->SetX($px2 += $ukuran_kolom_satker);
	$this->Cell($ukuran_kolom_dana, $h, 'Tanggal Hold', 1, 0, 'C',true);
	$this->SetX($px2 += $ukuran_kolom_dana);
	$this->Cell($ukuran_kolom_jenis_belanja, $h, 'Status Invoice', 1, 1, 'C',true);
	$this->Ln(8);  
...
//--------------------------
 //Laporan Data Revisi DIPA
    //pilihan
    $options = array(
    'filename' => 'Laporan Hold Invoice.PDF', //nama file penyimpanan, kosongkan jika output ke browser
