...
class FPDF_AutoWrapTable extends FPDF {
    ...
    public function rptDetailData() {
        ...
        $ukuran_kolom_jenis_belanja = 88;
		$ukuran_kolom_jenis_belanja1=$ukuran_kolom_jenis_belanja*3;
        $ukuran_kolom_satker = 45;
        ...
        $this->Cell($ukuran_kolom_akun, $h, 'Kewenangan', 1, 0., 'C', true);
		$this->SetX($px2 += $ukuran_kolom_akun);
        $this->Cell($ukuran_kolom_jenis_belanja, $h, 'Pagu', 1, 0, 'C', true);
        $px1 = $this->GetX();
		$this->SetX($px2 += $ukuran_kolom_jenis_belanja);
		
		$this->Cell($ukuran_kolom_jenis_belanja1, $h / 2, 'Pencadangan', 1, 0, 'C', true);
        $py1 = $this->GetY();
        $px2 = $px1;
        $py2 = $py1 + 20;
        $this->SetXY($px2, $py2);
        $this->Cell($ukuran_kolom_jenis_belanja, $h / 2, 'Kontrak', 1, 0, 'C', true);
        $this->SetX($px2 += $ukuran_kolom_jenis_belanja);
        $this->Cell($ukuran_kolom_jenis_belanja, $h / 2, 'Blokir', 1, 0, 'C', true);
        $this->SetX($px2 += $ukuran_kolom_jenis_belanja);
        $this->Cell($ukuran_kolom_jenis_belanja, $h / 2, 'Invoice', 1, 0, 'C', true);
        $this->SetX($px2 += $ukuran_kolom_jenis_belanja);
		$py3 = $this->GetY();
		...
		$ukuran_kolom_jenis_belanja, $ukuran_kolom_jenis_belanja,
		$ukuran_kolom_jenis_belanja, $ukuran_kolom_jenis_belanja));
        $this->SetAligns(array('C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'R', 'R', 'R', 'R', 'R', 'R', 'R'));
        if (count($this->data) == 0) {
            ...
            $this->SetX($px2 += $ukuran_kolom_jenis_belanja);
            $this->Cell($ukuran_kolom_jenis_belanja, $h, number_format($tot_invoice), 1, 0, 'R', true);
            $this->SetX($px2 += $ukuran_kolom_jenis_belanja);
            $this->Cell($ukuran_kolom_jenis_belanja, $h, number_format($tot_actual), 1, 0, 'R', true);
            $py3 = $this->GetY();
            $this->Cell($ukuran_kolom_jenis_belanja, $h, number_format($tot_balancing), 1, 1, 'R', true);
...
//--------------------------
//pilihan
$judul = 'Laporan Data Pagu Minus Non Belanja Pegawai'; //judul file laporan
$tipefile = '.pdf';
