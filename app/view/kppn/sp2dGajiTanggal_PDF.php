<?php
	...
	//File yang ditambah : sp2dGajiTanggal_PDF.php
...
//-------------------------------------
	...
	$this->Cell($ukuran_kolom_akun, $h, 'Tanggal SP2D', 1, 0, 'C',true);
	$this->SetX($px2 += $ukuran_kolom_akun);
	$this->Cell($ukuran_kolom_jenis_belanja, $h, 'Tanggal Proses SP2D', 1, 0, 'C',true);
