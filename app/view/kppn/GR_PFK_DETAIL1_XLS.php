...
//p2
$objPHPExcel->getActiveSheet()->setCellValue('B4', "Sumber Transaksi");
//p3
$objPHPExcel->getActiveSheet()->setCellValue('C4', "Nama wajib Bayar setor");
//p4
$objPHPExcel->getActiveSheet()->setCellValue('D4', "Tanggal Buku");
//p5
$objPHPExcel->getActiveSheet()->setCellValue('E4', "Tanggal Bayar");
//p6
$objPHPExcel->getActiveSheet()->setCellValue('F4', "NTPN/SP2D");
//p7
$objPHPExcel->getActiveSheet()->setCellValue('G4', "Rupiah");
...
if (count($this->data) == 0) {
	...
	$no++;
	$nil['p1']=$no;
	$nil['p2']=$value->get_keterangan();
	$nil['p3']=$value->get_nama_wajib_bayar_setor();
	$nil['p4']=$value->get_tanggal_buku();
	$nil['p5']=$value->get_tanggal_bayar();
	$nil['p6']=$value->get_ntpn();
	if ($value->get_rupiah()==0){
		$nil['p7']='0';
	}else{
		$nil['p7']=$value->get_rupiah();
	}		
