        ...
        <div class="btn-group-sm">
            <button type="button" class="btn btn-default dropdown-toggle fullwidth" data-toggle="dropdown" aria-expanded="false"><span class="glyphicon glyphicon-print"></span>&nbsp; Cetak <span class="caret"></span>
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="<?php echo URL; ?>PDF/sp2dBesok_PDF/<?php echo $kdkppn . "/" . $kdtgl_awal . "/" . $kdtgl_akhir . "/" . $kdbank; ?>/PDF">PDF</a></li>
                    <li><a href="<?php echo URL; ?>PDF/sp2dBesok_PDF/<?php echo $kdkppn . "/" . $kdtgl_awal . "/" . $kdtgl_akhir . "/" . $kdbank; ?>/XLS">EXCEL</a></li>
                  </ul>
        </div>
...
<div class="modal fade" id="modal-app-filter" tabindex="-1" role="dialog" aria-labelledby="app-filter-label" aria-hidden="true">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form id="filter-form" method="POST" action="sp2dBesok" enctype="multipart/form-data">
