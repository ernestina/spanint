...
class FPDF_AutoWrapTable extends PDF_Rotate {
    ...
    public function rptDetailData() {
		...
		$kolom2=53;
		$kolom3=80;
		$kolom_grandtotal=$kolom1+$kolom3+$kolom3;

        $this->SetFillColor(200, 200, 200);
        $left = $this->GetX();
        $this->Cell($kolom1, $h, 'No', 1, 0, 'C', true);
        $this->SetX($left += $kolom1);
        $this->Cell($kolom3, $h, 'Kode Program', 1, 0, 'C', true);
        ...
        $this->SetWidths(array($kolom1,$kolom3,$kolom3, $kolom2,$ukuran_kolom_jenis_belanja, $ukuran_kolom_jenis_belanja, $ukuran_kolom_jenis_belanja, $ukuran_kolom_jenis_belanja, $ukuran_kolom_jenis_belanja, $ukuran_kolom_jenis_belanja, $ukuran_kolom_jenis_belanja, $ukuran_kolom_jenis_belanja,$ukuran_kolom_jenis_belanja, $ukuran_kolom_pagu_total_sisa));
        $this->SetAligns(array('C', 'C','C', 'L', 'R', 'R', 'R', 'R', 'R', 'R', 'R', 'R', 'R', 'R', 'R', 'R'));
