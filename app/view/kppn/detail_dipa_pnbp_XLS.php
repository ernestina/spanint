...
//p4
$objPHPExcel->getActiveSheet()->setCellValue('D4', "Program");
//p5
$objPHPExcel->getActiveSheet()->setCellValue('E4', "Output");
//p6
$objPHPExcel->getActiveSheet()->setCellValue('F4', "Akun");
//p7
...
if (count($this->data) == 0) {
	...
	$nil['p4']=$value->get_program_code();
	$nil['p5']=$value->get_output_code();
	$nil['p6']=$value->get_account_code();
	if ($value->get_line_amount()==0){
		$nil['p7']='0';
	}else{
		$nil['p7']=$value->get_line_amount();
	}
