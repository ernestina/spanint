...
//p8
$objPHPExcel->getActiveSheet()->setCellValue('H4', "Posisis User");
//p9
$objPHPExcel->getActiveSheet()->setCellValue('I4', "Tanggal Mulai");
//p10
$objPHPExcel->getActiveSheet()->setCellValue('J4', "Waktu Mulai");
...
if (count($this->data) == 0) {
	...
	$nil['p10']=$value->get_time_begin_date();
