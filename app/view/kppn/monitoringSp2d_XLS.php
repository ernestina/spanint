...
if (count($this->data) == 0) {
	...
	$nil['p7']=$value->get_bank_name();
	$nil['p8']=$value->get_invoice_description();
	$nil['p9']=$value->get_return_desc();
	$nil['p10']=$value->get_payment_method();
	$nil['p11']=$value->get_sorbor_number();
	$nil['p12']=$value->get_sorbor_date();
