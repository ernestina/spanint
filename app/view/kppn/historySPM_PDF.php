...
//-------------------------------------
	...
	$px1 = $this->GetX();
	$this->SetX($left+50); 
	$this->MultiCell(0, $h/2, 'Laporan History Invoice');
	$py1 = $this->GetY();
	$px2 = $px1;
	$py2 = $py1;
	$this->SetXY($px2,$py2);
    ...
    $this->SetX($left += 30); $this->Cell($ukuran_kolom_pagu_total_sisa, $h, 'Nomor Invoice', 1, 0, 'C',true);
     $this->SetX($left += $ukuran_kolom_pagu_total_sisa); $this->Cell($ukuran_kolom_pagu_total, $h, 'Response', 1, 0, 'C',true);  
	$this->SetX($left += $ukuran_kolom_pagu_total); $this->Cell($ukuran_kolom_pagu_total, $h, 'Nama User', 1, 0, 'C',true);
	$px1 = $this->GetX();
	...
	$py2 = $py1;
	$this->SetXY($px2,$py2);
	$this->Cell($ukuran_kolom_jenis_belanja, $h, 'Waktu Mulai', 1, 0, 'C',true);
	$this->SetX($px2 += $ukuran_kolom_jenis_belanja);
	$this->Cell($ukuran_kolom_satker, $h, 'Nomor SP2D', 1, 1, 'C',true);
	$this->Ln(8);  
	
    $this->SetFont('Arial','',7);	
    $this->SetWidths(array(30,$ukuran_kolom_pagu_total_sisa,$ukuran_kolom_pagu_total,$ukuran_kolom_pagu_total,$ukuran_kolom_jenis_belanja,$ukuran_kolom_satker));
...
//--------------------------
 //Laporan Data Revisi DIPA
    //pilihan
    $options = array(
    'filename' => 'Laporan History Invoice.PDF', //nama file penyimpanan, kosongkan jika output ke browser
