...
<div class="modal fade" id="modal-app-filter" tabindex="-1" role="dialog" aria-labelledby="app-filter-label" aria-hidden="true">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form id="filter-form" method="POST" action="harianBO" enctype="multipart/form-data">
...
<?php } ?>
                    ...
                    <select class="form-control" type="text" name="bank" id="bank" value="<?php if (isset($this->bank)){echo $this->bank.MDRI;
} ?>">
