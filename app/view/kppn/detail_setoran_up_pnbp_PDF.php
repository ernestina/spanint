...
class FPDF_AutoWrapTable extends FPDF {
    ...
    public function rptDetailData() {
        ...
        $this->Cell($kolom2, $h, 'NTPN', 1, 0, 'C', true);
        $this->SetX($left += $kolom2);
        $this->Cell($kolom3, $h, 'Kode Satker', 1, 0, 'C', true);
        $this->SetX($left += $kolom3);
        $this->Cell($kolom4, $h, 'KPPN', 1, 0, 'C', true);
        $px1 = $this->GetX();
        ...
        $py2 = $py1;
        $this->SetXY($px2, $py2);
        $this->Cell($ukuran_kolom_jenis_belanja, $h, 'Tanggal', 1, 0, 'C', true);
...
//--------------------------
//pilihan
$judul = 'Laporan Pengawasan PNBP - Setoran UP/TUP PNBP'; //judul file laporan
$tipefile = '.pdf';
