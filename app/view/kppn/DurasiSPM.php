    ...
    <div class="container-fluid">
        <div class="row">
			...
			if (Session::get('role') == ADMIN || Session::get('role') == KANWIL) {
				...
				<a href="<?php echo URL; ?>PDF/DurasiSpm_PDF/<?php echo $kdkppn . "/" . $invoice . "/" . $jenisspm . "/" . $durasi . "/" . $kdtgl_awal . "/" . $kdtgl_akhir . "/" . $kdsatker; ?>/PDF" style="width: 100%" class="btn btn-default"><span class="glyphicon glyphicon-print"></span> PDF</a>
				</div><div class="col-lg-1 col-md-3 col-sm-12" style="padding-top: 10px;">
				<a href="<?php echo URL; ?>PDF/DurasiSpm_PDF/<?php echo $kdkppn . "/" . $invoice . "/" . $jenisspm . "/" . $durasi . "/" . $kdtgl_awal . "/" . $kdtgl_akhir . "/" . $kdsatker; ?>/XLS" style="width: 100%" class="btn btn-default"><span class="glyphicon glyphicon-print-xls"></span> XLS</a>
				<?php
				}
			}
