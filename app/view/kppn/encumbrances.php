    ...
    <div class="container-fluid">
        <div class="row">
			...
			//-----------------------------------------------
				...
				?>
					<a href="<?php echo URL; ?>PDF/DetailEncumbrances_PDF/<?php echo $code_id; ?>/PDF" style="width: 100%" class="btn btn-default"><span class="glyphicon glyphicon-print"></span> PDF</a>
				</div><div class="col-lg-1 col-md-3 col-sm-12" style="padding-top: 10px;">
					<a href="<?php echo URL; ?>PDF/DetailEncumbrances_PDF/<?php echo $code_id; ?>/XLS" style="width: 100%" class="btn btn-default"><span class="glyphicon glyphicon-print-xls"></span> XLS</a>
				<?php
			//--------------------------------------------------------
			?>  
