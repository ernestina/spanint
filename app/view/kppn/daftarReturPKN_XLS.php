...
//p2
$objPHPExcel->getActiveSheet()->setCellValue('B4', "Tgl SP2D");
//p3
$objPHPExcel->getActiveSheet()->setCellValue('C4', "No. SP2D");
//p4
$objPHPExcel->getActiveSheet()->setCellValue('D4', "Tgl SP2D-R");
//p5
$objPHPExcel->getActiveSheet()->setCellValue('E4', "No SP2D-R");
//p6
$objPHPExcel->getActiveSheet()->setCellValue('F4', "Debet");
//p7
$objPHPExcel->getActiveSheet()->setCellValue('G4', "Kredit");
//p8
$objPHPExcel->getActiveSheet()->setCellValue('H4', "Saldo");
...
if (count($this->data) == 0) {
	...
	$no++;
	$nil['p1']=$no;
	$nil['p2']=$value->get_statement_date();
	$nil['p3']=$value->get_receipt_number();
	$nil['p4']=$value->get_tgsp2d_pengganti();
	$nil['p5']=$value->get_nosp2d_pengganti();
	if ($value->get_nilai_sp2d_pengganti=0){
		$nil['p6']='0';
	}else{
		$nil['p6']=$value->get_nilai_sp2d_pengganti();
	}			
	...
	if ($saldo+=($value->get_amount() - $value->get_nilai_sp2d_pengganti())==0){
		$nil['p8']='0';
	}else{
		$nil['p8']=$saldo+=($value->get_amount() - $value->get_nilai_sp2d_pengganti());
	}			
