...
//p3
$objPHPExcel->getActiveSheet()->setCellValue('C4', "User Name");
//p4
$objPHPExcel->getActiveSheet()->setCellValue('D4', "NIP");
//p5
$objPHPExcel->getActiveSheet()->setCellValue('E4', "Posisi");
//p6
$objPHPExcel->getActiveSheet()->setCellValue('F4', "Email Depkeu");
//p7
$objPHPExcel->getActiveSheet()->setCellValue('G4', "Tanggal Mulai Aktif");
//p8
...
if (count($this->data) == 0) {
	...
	$nil['p1']=$no;
	$nil['p2']=$value->get_last_name();
	$nil['p3']=$value->get_user_name();
	$nil['p4']=$value->get_attribute1();
	$nil['p5']=$value->get_name();
	$nil['p6']=$value->get_email_address();
	$nil['p7']=$value->get_start_date();
	$nil['p8']=$value->get_end_date();
