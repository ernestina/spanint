...
//p2
$objPHPExcel->getActiveSheet()->setCellValue('B4', "Akun");
//p3
$objPHPExcel->getActiveSheet()->setCellValue('C4', "Uraian Akun");
//p4
$objPHPExcel->getActiveSheet()->setCellValue('D4', "Potongan SPM");
//p5
$objPHPExcel->getActiveSheet()->setCellValue('E4', "Setoran MPN");
//p6
...
if (count($this->data) == 0) {
	...
	$nil['p3']=$value->get_uraian_akun();
	if ($value->get_potongan_spm()==0){
		$nil['p4']='0';
	}else{
		$nil['p4']=$value->get_potongan_spm();
	}		
	if ($value->get_setoran_mpn()==0){
		$nil['p5']='0';
	}else{
		$nil['p5']=$value->get_setoran_mpn();
	}		
	if ($value->get_total()==0){
		$nil['p6']='0';
	}else{
		$nil['p6']=$value->get_total();
	}		
