...
/* //----------------------------------------------------
  ...
  //File yang ditambah : sp2dHariIni_PDF.php
...
class FPDF_AutoWrapTable extends FPDF {
    ...
    public function rptDetailData() {
        ...
        $px1 = $this->GetX();
        $this->SetX($left + 50);
        $this->MultiCell(0, $h / 2, 'Laporan Monitoring SP2D Terbit dan Tertanggal Hari Yang Sama  ');
        $py1 = $this->GetY();
        $px2 = $px1;
        $py2 = $py1;
        $this->SetXY($px2, $py2);
...
//pilihan
$options = array(
    'filename' => 'Laporan Monitoring SP2D Terbit dan Tertanggal Hari Yang Sama.PDF', //nama file penyimpanan, kosongkan jika output ke browser
