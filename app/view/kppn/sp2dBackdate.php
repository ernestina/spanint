...
<div class="main-window-segment" style="padding-top: none; padding-bottom: 20px;">
    ...
    //File yang diubah : sp2dBackdate.php
...
isset($this->d_bank) || isset($this->d_tgl_awal) || isset($this->d_tgl_akhir)
    ...
    <a href="<?php echo URL; ?>PDF/sp2dBackdate_PDF/<?php echo $kdkppn . "/" . $kdtgl_awal . "/" . $kdtgl_akhir . "/" . $kdbank; ?>" style="width: 100%" class="btn btn-default"><span class="glyphicon glyphicon-print"></span> PDF</a>
