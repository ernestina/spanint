...
if (count($this->data) == 0) {
	...
	if ($value->get_encumbered_amount()==0){
		...
		$nil['p9']=$value->get_encumbered_amount();
	}			
	if ($value->get_billed_amount()==0){
		$nil['p10']='0';
	}else{
		$nil['p10']=$value->get_billed_amount();
	}			
	if ($value->get_sisa_encumbrence()==0){
		$nil['p11']='0';
	}else{
		$nil['p11']=$value->get_sisa_encumbrence();
	}			
