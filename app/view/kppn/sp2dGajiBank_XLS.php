...
//p3
$objPHPExcel->getActiveSheet()->setCellValue('C4', "No Invoice");
//p4
$objPHPExcel->getActiveSheet()->setCellValue('D4', "No. SP2D");
//p5
$objPHPExcel->getActiveSheet()->setCellValue('E4', "BO I");
//p6
$objPHPExcel->getActiveSheet()->setCellValue('F4', "Bank Rekening Penerima");
//p7
$objPHPExcel->getActiveSheet()->setCellValue('G4', "Nama Supplier");
//p8
$objPHPExcel->getActiveSheet()->setCellValue('H4', "Rekening Supplier");
//p9
$objPHPExcel->getActiveSheet()->setCellValue('I4', "Deskripsi");
...
if (count($this->data) == 0) {
	...
	$nil['p5']=$value->get_bank_account_name();
	$nil['p6']=$value->get_bank_name();
	$nil['p7']=$value->get_vendor_name();
	$nil['p8']=$value->get_vendor_ext_bank_account_num();
	$nil['p9']=$value->get_invoice_description();
