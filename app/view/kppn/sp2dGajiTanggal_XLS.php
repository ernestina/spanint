...
//p5
$objPHPExcel->getActiveSheet()->setCellValue('E4', "Tanggal SP2D");
//p6
$objPHPExcel->getActiveSheet()->setCellValue('F4', "Tanggal Proses SP2D");
//p7
...
if (count($this->data) == 0) {
	...
	$nil['p7']=$value->get_invoice_description();
