        ...
        <div class="row">
			...
			if (Session::get('role') == ADMIN || Session::get('role') == KANWIL) {
				if (isset($this->d_nama_kppn)) {
					...
					?>
					<a href="<?php echo URL; ?>PDF/posisiSpm_PDF/<?php echo $kdkppn; ?>/PDF" style="width: 100%" class="btn btn-default"><span class="glyphicon glyphicon-print"></span> PDF</a>
					</div><div class="col-lg-1 col-md-3 col-sm-12" style="padding-top: 10px;">
					<a href="<?php echo URL; ?>PDF/posisiSpm_PDF/<?php echo $kdkppn; ?>/XLS" style="width: 100%" class="btn btn-default"><span class="glyphicon glyphicon-print-xls"></span> XLS</a>
					<?php
				} 
			}
            ...
            if (isset($this->data)) {
                if (empty($this->data)) {
                    ...
                    foreach ($this->data as $value) {
                        ...
                        //echo "<td><a href=".URL."dataSPM/detailposisiSpm/".$value->get_invoice_num().">" . $value->get_invoice_num() . "</a></td>";
