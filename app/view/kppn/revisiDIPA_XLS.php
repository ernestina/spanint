...
//p2
$objPHPExcel->getActiveSheet()->setCellValue('B4', "Nomor DIPA");
//p3
$objPHPExcel->getActiveSheet()->setCellValue('C4', "Revisi Ke");
//p4
$objPHPExcel->getActiveSheet()->setCellValue('D4', "Tgl Post Revisi");
//p5
$objPHPExcel->getActiveSheet()->setCellValue('E4', "Pagu");
//p6
$objPHPExcel->getActiveSheet()->setCellValue('F4', "Satker");
//p7
...
//p10
$objPHPExcel->getActiveSheet()->setCellValue('J4', "Dana");
//p11
$objPHPExcel->getActiveSheet()->setCellValue('K4', "Bank");
//p12
$objPHPExcel->getActiveSheet()->setCellValue('L4', "Kewenangan)");
//p13
$objPHPExcel->getActiveSheet()->setCellValue('M4', "Tipe Anggaran");
//p14
$objPHPExcel->getActiveSheet()->setCellValue('N4', "Kolorari");
//p15
$objPHPExcel->getActiveSheet()->setCellValue('O4', "Kode Cadangan");
...
if (count($this->data) == 0) {
	...
	$nil['p1']=$no;
	$nil['p2']=$value->get_dipa_no();
	$nil['p3']=$value->get_revision_no();
	$nil['p4']=$value->get_tanggal_posting_revisi();
	if ($value->get_line_amount()==0){
		$nil['p5']='0';
	}else{
		$nil['p5']=$value->get_line_amount();
	}
	
	$nil['p6']=$value->get_satker_code();
	$nil['p7']=$value->get_account_code();
	$nil['p8']=$value->get_program_code();
	$nil['p9']=$value->get_output_code();
	$nil['p10']=$value->get_dana_code();
	$nil['p11']=$value->get_bank_code();
	$nil['p12']=$value->get_kewenangan_code();
	$nil['p13']=$value->get_budget_type();
	$nil['p14']=$value->get_intraco_code();
	$nil['p15']=$value->get_cadangan_code();
