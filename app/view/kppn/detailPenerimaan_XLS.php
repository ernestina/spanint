...
//p3
$objPHPExcel->getActiveSheet()->setCellValue('C4', "NTB");
//p4
$objPHPExcel->getActiveSheet()->setCellValue('D4', "Tgl. Penerimaan");
//p5
$objPHPExcel->getActiveSheet()->setCellValue('E4', "Kode Bank");
//p6
$objPHPExcel->getActiveSheet()->setCellValue('F4', "No. Rek. Persepsi");
//p7
$objPHPExcel->getActiveSheet()->setCellValue('G4', "Jumlah Rupiah");
//p8
$objPHPExcel->getActiveSheet()->setCellValue('H4', "Satker/KPPN/Akun");
...
if (count($this->data) == 0) {
	...
	$no++;
	$nil['p1']=$no;
	$nil['p2']=$value->get_status();
	$nil['p3']=$value->get_file_name();
	$nil['p4']=$value->get_gl_date();
	$nil['p5']=$value->get_bank_code();
	$nil['p6']=$value->get_bank_account_num();
	if ($value->get_keterangan()==0){
		$nil['p7']='0';
	}else{
		$nil['p7']=$value->get_keterangan();
	}
	$nil['p8']=$value->get_resp_name();
...
$objPHPExcel->getActiveSheet()->getStyle('B5:B1000')->getNumberFormat()->setFormatCode('0000000000000000');
