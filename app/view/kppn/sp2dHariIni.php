    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-10 col-md-6 col-sm-12">
                <h2>Monitoring SP2D Terbit dan Tertanggal Hari yang Sama</h2>
            </div>
			...
			if( isset($this->d_bank) || isset($this->d_tgl_awal) || isset($this->d_tgl_akhir) ){
				...
				<a href="<?php echo URL; ?>PDF/sp2dHariIni_PDF/<?php echo $kdkppn . "/" . $kdtgl_awal . "/" . $kdtgl_akhir . "/" . $kdbank; ?>/PDF" style="width: 100%" class="btn btn-default"><span class="glyphicon glyphicon-print"></span> PDF</a>
				</div><div class="col-lg-1 col-md-3 col-sm-12" style="padding-top: 10px;">
				<a href="<?php echo URL; ?>PDF/sp2dHariIni_PDF/<?php echo $kdkppn . "/" . $kdtgl_awal . "/" . $kdtgl_akhir . "/" . $kdbank; ?>/XLS" style="width: 100%" class="btn btn-default"><span class="glyphicon glyphicon-print-xls"></span> XLS</a>
			<?php
			//----------------------------------------------------		
...
<div class="modal fade" id="modal-app-filter" tabindex="-1" role="dialog" aria-labelledby="app-filter-label" aria-hidden="true">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form id="filter-form" method="POST" action="sp2dHariIni" enctype="multipart/form-data">
