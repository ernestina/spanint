...
//p9
$objPHPExcel->getActiveSheet()->setCellValue('I4', "Pagu");
//p10
$objPHPExcel->getActiveSheet()->setCellValue('J4', "Kontrak(Pencadangan)");
//p11
$objPHPExcel->getActiveSheet()->setCellValue('K4', "Blokir(Pencadangan)");
//p12
$objPHPExcel->getActiveSheet()->setCellValue('L4', "Invoice(Pencadangan)");
//p13
...
if (count($this->data) == 0) {
	...
	if ($value->get_invoice()==0){
		$nil['p12']='0';
	}else{
		$nil['p12']=$value->get_invoice();
	}			
