...
//p4
$objPHPExcel->getActiveSheet()->setCellValue('D4', "Dana");
//p5
...
//p8
$objPHPExcel->getActiveSheet()->setCellValue('H4', "Revisi Ke");
//p9
$objPHPExcel->getActiveSheet()->setCellValue('I4', "Usulan Revisi");
...
if (count($this->data) == 0) {
	...
	$nil['p4']=$value->get_dana();
	$nil['p5']=$value->get_program();
	$nil['p6']=$value->get_output();
	$nil['p7']=$value->get_akun();
	$nil['p8']=$value->get_revision_no();	
	if ($value->get_usulan_revisi()==0){
		$nil['p9']='0';
	}else{
		$nil['p9']=$value->get_usulan_revisi();
	}
