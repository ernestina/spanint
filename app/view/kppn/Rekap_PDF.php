...
//-------------------------------------
	...
	$px1 = $this->GetX();
	$this->SetX($left+50); 
	$this->MultiCell(0, $h/2, 'Laporan Daftar SP2D Satker');
	$py1 = $this->GetY();
	$px2 = $px1;
	$py2 = $py1;
	$this->SetXY($px2,$py2);
    ...
    $this->SetX($left += 30); $this->Cell($ukuran_kolom_pagu_total_sisa, $h, 'Nomor SP2D', 1, 0, 'C',true);
     $this->SetX($left += $ukuran_kolom_pagu_total_sisa); $this->Cell($ukuran_kolom_pagu_total, $h, 'Tanggal Selesai SP2D', 1, 0, 'C',true);  
	$this->SetX($left += $ukuran_kolom_pagu_total); $this->Cell($ukuran_kolom_pagu_total, $h, 'Tanggal SP2D', 1, 0, 'C',true);
	$px1 = $this->GetX();
...
//--------------------------
 //Laporan Data Revisi DIPA
    //pilihan
    $options = array(
    'filename' => 'Laporan Daftar SP2D Satker.PDF', //nama file penyimpanan, kosongkan jika output ke browser
