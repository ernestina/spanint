...
<div class="main-window-segment" style="padding-top: none; padding-bottom: 20px;">
    ...
    //File yang diubah : sp2dNilaiMinus.php
    ...
    <a href="<?php echo URL; ?>PDF/sp2dNilaiMinus_PDF/<?php echo $kdkppn . "/" . $kdtgl_awal . "/" . $kdtgl_akhir . "/" . $kdbank; ?>" class="btn btn-default" style="width:100%"><span class="glyphicon glyphicon-print"></span> PDF</a>
