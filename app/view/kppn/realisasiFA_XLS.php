...
//p5
$objPHPExcel->getActiveSheet()->setCellValue('E4', "Prog.");
//p6
$objPHPExcel->getActiveSheet()->setCellValue('F4', "Output");
//p7
$objPHPExcel->getActiveSheet()->setCellValue('G4', "Dana");
//p8
$objPHPExcel->getActiveSheet()->setCellValue('H4', "Kewenangan");
//p9
$objPHPExcel->getActiveSheet()->setCellValue('I4', "Lokasi");
//p10
$objPHPExcel->getActiveSheet()->setCellValue('J4', "Tipe Anggaran");
//p11
$objPHPExcel->getActiveSheet()->setCellValue('K4', "Pagu");
//p12
$objPHPExcel->getActiveSheet()->setCellValue('L4', "Pencadangan)");
//p13
$objPHPExcel->getActiveSheet()->setCellValue('M4', "Realisasi");
//p14
$objPHPExcel->getActiveSheet()->setCellValue('N4', "Sisa Pagu");
...
if (count($this->data) == 0) {
	...
	$nil['p8']=$value->get_kewenangan();
	$nil['p9']=$value->get_lokasi();
	$nil['p10']=$value->get_budget_type();
	
	//pengecekan
	if ($value->get_budget_amt()==0){
		$nil['p11']='0';
	}else{
		$nil['p11']=$value->get_budget_amt();
	}
	
	if ($value->get_encumbrance_amt()==0){
		$nil['p12']='0';
	}else{
		$nil['p12']=$value->get_encumbrance_amt();
	}			
	if ($value->get_actual_amt==0){
		$nil['p13']='0';
	}else{
		$nil['p13']=$value->get_actual_amt();
	}			
	if ($value->get_balancing_amt()==0){
		$nil['p14']='0';
	}else{
		$nil['p14']=$value->get_balancing_amt();
	}			
...
$objPHPExcel->getActiveSheet()->getStyle('E5:F1000')->getNumberFormat()->setFormatCode('0000000');
