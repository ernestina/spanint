<div id="top">
    <div id="header">
        <h2>CEK SISA PAGU DIPA SATKER PADA <?php
    ...
    <div id="xModal" class="modalDialog" >
        <div>
            ...
            <div id="top">
                <form method="POST" action="nmsatker1" enctype="multipart/form-data">
...
<?php } ?>
    ...
    echo $this->kdsatker;
                    ...
                    <input type="text" name="nmsatker" id="nmsatker" value="<?php if (isset($this->nmsatker)) {
    echo $this->nmsatker;
} ?>">
