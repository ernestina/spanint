...
class FPDF_AutoWrapTable extends FPDF {
    ...
    public function rptDetailData() {
        ...
        $this->Cell($ukuran_kolom_dana, $h, 'Nama Satker', 1, 0, 'C', true);
        $this->SetX($left += $ukuran_kolom_dana);
        $this->Cell($ukuran_kolom_pagu_total, $h, 'KPPN', 1, 0, 'C', true);
        $px1 = $this->GetX();
        ...
        $py2 = $py1;
        $this->SetXY($px2, $py2);
        $this->Cell($ukuran_kolom_akun, $h, 'Revisi Ke', 1, 0, 'C', true);
        $this->SetX($px2 += $ukuran_kolom_akun);
        $this->Cell($ukuran_kolom_jenis_belanja, $h, 'Tahapan Proses', 1, 0, 'C', true);
        $this->SetX($px2 += $ukuran_kolom_jenis_belanja);
        $this->Cell($ukuran_kolom_satker, $h, 'Tanggal', 1, 1, 'C', true);
        $this->Ln(8);

        $this->SetFont('Arial', '', 7);
        $this->SetWidths(array(30, $ukuran_kolom_pagu_total_sisa,
		$ukuran_kolom_dana, $ukuran_kolom_pagu_total,
		$ukuran_kolom_akun,$ukuran_kolom_jenis_belanja, $ukuran_kolom_satker));
...
//--------------------------
//pilihan
$judul = 'Laporan Informasi Proses Revisi DIPA '; //judul file laporan
$tipefile = '.pdf';
