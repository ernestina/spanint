<?php
	...
	//File yang ditambah : sp2dGajiDobel_PDF.php
...
//-------------------------------------
	...
	$px1 = $this->GetX();
	$this->SetX($left+50); 
	$this->MultiCell(0, $h/2, 'Laporan Monitoring SP2D Gaji Terindikasi Dobel');
	$py1 = $this->GetY();
	$px2 = $px1;
	$py2 = $py1;
	$this->SetXY($px2,$py2);
...
//--------------------------
 //Laporan Data Revisi DIPA
    //pilihan
    $options = array(
    'filename' => 'Laporan Monitoring SP2D Gaji Terindikasi Dobel.PDF', //nama file penyimpanan, kosongkan jika output ke browser
