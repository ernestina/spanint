				...
				<div class="btn-group-sm">
                    <button type="button" class="btn btn-default dropdown-toggle fullwidth" data-toggle="dropdown" aria-expanded="false"><span class="glyphicon glyphicon-print"></span>&nbsp; Cetak <span class="caret"></span>
                          ...
                          <ul class="dropdown-menu" role="menu">
                            <li><a href="<?php echo URL; ?>PDF/DataBPN_PDF/<?php echo $kdkppn . "/" . $kdsatker . "/" . $kdtgl_awal . "/" . $kdtgl_akhir . "/" . $kdnosp2d . "/" . $kdspm; ?>/PDF">PDF</a></li>
                            <li><a href="<?php echo URL; ?>PDF/DataBPN_PDF/<?php echo $kdkppn . "/" . $kdsatker . "/" . $kdtgl_awal . "/" . $kdtgl_akhir . "/" . $kdnosp2d . "/" . $kdspm; ?>/XLS">EXCEL</a></li>
                          </ul>
                </div>
            ...
            if (isset($this->data)) {
                if (empty($this->data)) {
                    ...
                    foreach ($this->data as $value) {
                        ...
                        echo "<td class='align-right'>" . number_format($value->get_nilai_ori()) . "</td>";
                        echo "</tr>	";
                    }
                }
            } else {
