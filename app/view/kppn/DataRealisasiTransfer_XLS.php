...
//p2
$objPHPExcel->getActiveSheet()->setCellValue('B4', "Lokasi");
//p3
$objPHPExcel->getActiveSheet()->setCellValue('C4', "Nama Lokasi");
//p4
$objPHPExcel->getActiveSheet()->setCellValue('D4', "DBH");
//p5
$objPHPExcel->getActiveSheet()->setCellValue('E4', "DAU");
//p6
$objPHPExcel->getActiveSheet()->setCellValue('F4', "DAK");
//p7
$objPHPExcel->getActiveSheet()->setCellValue('G4', "DANA OTONOMI KHUSUS");
//p8
$objPHPExcel->getActiveSheet()->setCellValue('H4', "DANA PENYESUAIAN");
//p9
$objPHPExcel->getActiveSheet()->setCellValue('I4', "DANA KEISTIMEWAAN DIY");
//p10
$objPHPExcel->getActiveSheet()->setCellValue('J4', "SUSPEND");
//p11
$objPHPExcel->getActiveSheet()->setCellValue('K4', "Total Realisasi Belanja Transfer");
...
if (count($this->data) == 0) {
	...
	$nil['p1']=$no;
	$nil['p2']=$value->get_lokasi();
	$nil['p3']=$value->get_nmlokasi();
	...
	if ($value->get_belanja_52()==0){
		...
		$nil['p5']=$value->get_belanja_52();
	}			

	if ($value->get_belanja_53()==0){
		$nil['p6']='0';
	}else{
		$nil['p6']=$value->get_belanja_53();
	}			
	if ($value->get_belanja_54()==0){
		$nil['p7']='0';
	}else{
		$nil['p7']=$value->get_belanja_54();
	}			
	if ($value->get_belanja_55()==0){
		$nil['p8']='0';
	}else{
		$nil['p8']=$value->get_belanja_55();
	}			
	if ($value->get_belanja_56()==0){
		$nil['p9']='0';
	}else{
		$nil['p9']=$value->get_belanja_56();
	}			
	if ($value->get_belanja_59()==0){
		$nil['p10']='0';
	}else{
		$nil['p10']=$value->get_belanja_59();
	}			
	if ($value->get_realisasi()==0){
		$nil['p11']='0';
	}else{
		$nil['p11']=$value->get_realisasi();
	}			
