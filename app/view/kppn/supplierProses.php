...
<?php if (isset($this->data)) { ?>
    ...
    <?php if (empty($this->data)) { ?>
                ...
                <?php } else { ?>
                    ...
                    <tr>
                        <td ><?php echo $no++; ?></td>
                        <td class='align-left'><?php echo $value->get_nip_id() . "<br>" . $value->get_nama_id(); ?></td>
                        <td ><?php echo $value->get_pos_id(); ?></td>
                        <td ><?php echo $value->get_file(); ?></td>
                        <td class='align-left'><?php echo $value->get_vendor(); ?></td>
                        <td ><?php echo $value->get_tgl_supplier(); ?></td>
                        <td ><?php echo $value->get_status_supplier(); ?></td>
                    </tr>
