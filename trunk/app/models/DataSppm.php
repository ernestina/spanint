...
class DataSppm {
	...
	public function get_sp2d_rekap($filter) {
		...
		$sql = "SELECT DECODE(BANK_ACCOUNT_NAME,'MDRI','MANDIRI',
				...
				SELECT BANK_ACCOUNT_NAME, SUM(JUMLAH_SP2D) GAJI, NULL NON_GAJI, NULL RETUR, NULL VOID FROM REKAPITULASI_SP2D WHERE JENIS_SP2D = '1' ".$sql_tgl." GROUP BY BANK_ACCOUNT_NAME, JENIS_SP2D  
				UNION
				SELECT BANK_ACCOUNT_NAME, NULL GAJI, SUM(JUMLAH_SP2D) NON_GAJI, NULL RETUR, NULL VOID FROM REKAPITULASI_SP2D WHERE JENIS_SP2D = '2' ".$sql_tgl." GROUP BY BANK_ACCOUNT_NAME, JENIS_SP2D 
				UNION
				SELECT BANK_ACCOUNT_NAME, NULL GAJI, NULL NON_GAJI, SUM(JUMLAH_SP2D) RETUR, NULL VOID FROM REKAPITULASI_SP2D WHERE JENIS_SP2D = '3' ".$sql_tgl." GROUP BY BANK_ACCOUNT_NAME, JENIS_SP2D 
				UNION
				SELECT BANK_ACCOUNT_NAME, NULL GAJI, NULL NON_GAJI, NULL RETUR, SUM(JUMLAH_SP2D) VOID FROM REKAPITULASI_SP2D WHERE JENIS_SP2D = '4' ".$sql_tgl." GROUP BY BANK_ACCOUNT_NAME, JENIS_SP2D
