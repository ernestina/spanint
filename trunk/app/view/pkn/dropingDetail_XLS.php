...
//p2
$objPHPExcel->getActiveSheet()->setCellValue('B4', "Tanggal - Jam");
//p3
$objPHPExcel->getActiveSheet()->setCellValue('C4', "Mata Uang");
//p4
$objPHPExcel->getActiveSheet()->setCellValue('D4', "Nomor Transaksi BAT");
//p5
$objPHPExcel->getActiveSheet()->setCellValue('E4', "Nilai Transaksi");
//p6
$objPHPExcel->getActiveSheet()->setCellValue('F4', "Nama Rekening");
...
if (count($this->data) == 0) {
	...
	$nil['p3']=$value->get_payment_currency_code();
	$nil['p4']=$value->get_bank_trxn_number();
	if ($value->get_payment_amount()==0){
		$nil['p5']='0';
	}else{
		$nil['p5']=$value->get_payment_amount();
	}			
	$nil['p6']=$value->get_attribute4();
