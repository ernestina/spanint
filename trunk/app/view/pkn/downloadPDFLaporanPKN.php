    ...
    <?php if (empty($this->data)) { ?>
                ...
                <?php } else { ?>
                    ...
                    <tr>
                        ...
                        <td class="align-center"><?php echo $value->get_argument_text(); ?></td>
                        <!--<?php /*if(!(strtotime(substr($value->get_argument_text(),21,10)) > '01-01-2010' || strtotime(substr($value->get_argument_text(),21,10)) < '01-01-2020')){ */?>
