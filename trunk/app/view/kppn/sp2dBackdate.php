...
if(isset($this->d_bank) || isset($this->d_tgl_awal) || isset($this->d_tgl_akhir)){
    ...
    <a href="<?php echo URL; ?>PDF/sp2dBackdate_PDF/<?php echo $kdkppn . "/" . $kdtgl_awal . "/" . $kdtgl_akhir . "/" . $kdbank; ?>/PDF" style="width: 100%" class="btn btn-default"><span class="glyphicon glyphicon-print"></span> PDF</a>
</div><div class="col-lg-1 col-md-3 col-sm-12" style="padding-top: 10px;">
    <a href="<?php echo URL; ?>PDF/sp2dBackdate_PDF/<?php echo $kdkppn . "/" . $kdtgl_awal . "/" . $kdtgl_akhir . "/" . $kdbank; ?>/XLS" style="width: 100%" class="btn btn-default"><span class="glyphicon glyphicon-print-xls"></span> XLS</a>
<?php
//----------------------------------------------------		
