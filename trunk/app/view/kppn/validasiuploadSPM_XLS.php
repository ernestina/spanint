...
//p2
$objPHPExcel->getActiveSheet()->setCellValue('B4', "Tanggal Upload");
//p3
$objPHPExcel->getActiveSheet()->setCellValue('C4', "Nama File");
//p4
$objPHPExcel->getActiveSheet()->setCellValue('D4', "Kode Satker");
//p5
$objPHPExcel->getActiveSheet()->setCellValue('E4', "Status Code");
...
if (count($this->data) == 0) {
	...
	$nil['p4']=$value->get_satker_code();	
	$nil['p5']=$value->get_status_code();
