...
class FPDF_AutoWrapTable extends FPDF {
    ...
    public function rptDetailData() {
        ...
        $this->Cell($ukuran_kolom_deskripsi, $h, 'Nama User', 1, 0, 'C', true);
        $px1 = $this->GetX();
        $this->SetX($left += $ukuran_kolom_deskripsi);
        $py1 = $this->GetY();
        $px2 = $px1;
        $py2 = $py1;
        $this->SetXY($px2, $py2);
        ...
        $this->SetWidths(array(30, $ukuran_kolom_pagu_total_sisa, $ukuran_kolom_pagu_total, $ukuran_kolom_deskripsi, $ukuran_kolom_jenis_belanja, $ukuran_kolom_satker));
        $this->SetAligns(array('C', 'C', 'L', 'L', 'R', 'C'));
