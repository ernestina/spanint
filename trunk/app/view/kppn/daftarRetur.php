...
<a href="#oModal" class="modal">FILTER DATA</a>
	...
	<div id="top">	
		...
		<select type="text" name="status" id="status">
			...
			<option value='SUDAH PROSES' <?php if ($this->d_status == 'SUDAH PROSES'){echo "selected";}?>>SUDAH PROSES</option>
			<option value='BELUM PROSES' <?php if ($this->d_status == 'BELUM PROSES'){echo "selected";}?>>BELUM PROSES</option>
