...
//p3
$objPHPExcel->getActiveSheet()->setCellValue('C4', "Tanggal Invoice");
//p4
$objPHPExcel->getActiveSheet()->setCellValue('D4', "Nilai Invoice");
//p5
$objPHPExcel->getActiveSheet()->setCellValue('E4', "Uraian Invoice");
//p6
$objPHPExcel->getActiveSheet()->setCellValue('F4', "Nama File");
//p7
$objPHPExcel->getActiveSheet()->setCellValue('G4', "Status Code");
//p8
$objPHPExcel->getActiveSheet()->setCellValue('H4', "Supplier");
//p9
$objPHPExcel->getActiveSheet()->setCellValue('I4', "Site Supplier");
//p10
$objPHPExcel->getActiveSheet()->setCellValue('J4', "Nama Kolom");
//p11
$objPHPExcel->getActiveSheet()->setCellValue('K4', "Nilai Kolom");
//p12
...
if (count($this->data) == 0) {
	...
	$nil['p3']=$value->get_invoice_date();
	$nil['p4']=$value->get_invoice_amount();	
	$nil['p5']=$value->get_description();
	$nil['p6']=$value->get_file_name();
	$nil['p7']=$value->get_status_code();
	$nil['p8']=$value->get_vendor_name();
	$nil['p9']=$value->get_vendor_site_code();
	$nil['p10']=$value->get_column_name();
	$nil['p11']=$value->get_column_value();
	$nil['p12']=$value->get_error_message();
