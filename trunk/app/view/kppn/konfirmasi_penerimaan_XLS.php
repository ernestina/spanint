...
//p4
$objPHPExcel->getActiveSheet()->setCellValue('D4', "Bagan Akun SPAN 2");
//p5
$objPHPExcel->getActiveSheet()->setCellValue('E4', "Bagan Akun SPAN 3");
//p6
$objPHPExcel->getActiveSheet()->setCellValue('F4', "Bagan Akun SPAN 4");
//p7
$objPHPExcel->getActiveSheet()->setCellValue('G4', "Bagan Akun SPAN 5");
//p8
$objPHPExcel->getActiveSheet()->setCellValue('H4', "Bagan Akun SPAN 6");
//p9
$objPHPExcel->getActiveSheet()->setCellValue('I4', "Bagan Akun SPAN 7");
//p10
$objPHPExcel->getActiveSheet()->setCellValue('J4', "Bagan Akun SPAN 8");
//p11
$objPHPExcel->getActiveSheet()->setCellValue('K4', "Bagan Akun SPAN 9");
//p12
$objPHPExcel->getActiveSheet()->setCellValue('L4', "Bagan Akun SPAN 10");
//p13
$objPHPExcel->getActiveSheet()->setCellValue('M4', "Bagan Akun SPAN 11");
//p14
$objPHPExcel->getActiveSheet()->setCellValue('N4', "Bagan Akun SPAN 12");
//p15
$objPHPExcel->getActiveSheet()->setCellValue('O4', "Mata Uang");
//p16
$objPHPExcel->getActiveSheet()->setCellValue('P4', "Nilai");
//Data
if (count($this->data) == 0) {
	...
	$nil['p1']=$no;
	$nil['p2']=$value->get_gl_date();
	$nil['p3']=$value->get_resp_name();	
	$nil['p4']=$value->get_segment2();
	$nil['p5']=$value->get_segment3();
	$nil['p6']=$value->get_segment4();
	$nil['p7']=$value->get_segment5();
	$nil['p8']=$value->get_segment6();
	$nil['p9']=$value->get_segment7();
	$nil['p10']=$value->get_segment8();
	$nil['p11']=$value->get_segment9();
	$nil['p12']=$value->get_segment10();
	$nil['p13']=$value->get_segment11();
	$nil['p14']=$value->get_segment12();
	$nil['p15']=$value->get_mata_uang();

	if ($value->get_amount()==0){
	$nil['p16']='0';
}else{
	$nil['p16']=$value->get_amount();
}			
