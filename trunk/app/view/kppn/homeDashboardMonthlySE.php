    ...
    <div id="fitur">
        ...
        <div id="bottom-status-bar">
            <div>
                ...
                <div style="float: right;">Periode: <a href="<?php echo URL; ?>home/harian">Hari Ini</a><a href="<?php echo URL; ?>home/mingguan" >7 Hari</a><a href="<?php echo URL; ?>home/bulanan" class="active">30 Hari</a></div>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function homeDisplayProcessing() {
        ...
        $.ajax({
            'async': false,
            'global': false,
            'url': '<?php echo URL; ?>home/bulananJSON'+urlAddon,
            'dataType': "json",
