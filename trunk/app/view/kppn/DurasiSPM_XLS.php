...
//p3
$objPHPExcel->getActiveSheet()->setCellValue('C4', "Nomor SP2D");
//p4
$objPHPExcel->getActiveSheet()->setCellValue('D4', "Jenis SPM");
//p5
$objPHPExcel->getActiveSheet()->setCellValue('E4', "Tanggal Upload");
//p6
$objPHPExcel->getActiveSheet()->setCellValue('F4', "Waktu Upload");
//p7
$objPHPExcel->getActiveSheet()->setCellValue('G4', "Tanggal Selesai SP2D");
//p8
$objPHPExcel->getActiveSheet()->setCellValue('H4', "Jam Selesai SP2D");
//p9
...
if (count($this->data) == 0) {
	...
	$nil['p3']=$value->get_check_number();
	$nil['p4']=$value->get_attribute1();
	$nil['p5']=$value->get_aia_creation_date();
	$nil['p6']=$value->get_jam_upload();
	$nil['p7']=$value->get_aca_creation_date();
	$nil['p8']=$value->get_jam_selesai_sp2d();
	$nil['p9']=$value->get_durasi();
