...
//p9
$objPHPExcel->getActiveSheet()->setCellValue('I4', "Description");
//p10
$objPHPExcel->getActiveSheet()->setCellValue('J4', "Blokir/Kontrak");
//p11
$objPHPExcel->getActiveSheet()->setCellValue('K4', "Realisasi");
...
if (count($this->data) == 0) {
	...
	$nil['p9']=$value->get_description();
	if ($value->get_blokir_kontrak=0){
		$nil['p10']='0';
	}else{
		$nil['p10']=$value->get_blokir_kontrak();
	}			
	if ($value->get_blokir_realisasi()==0){
		$nil['p11']='0';
	}else{
		$nil['p11']=$value->get_blokir_realisasi();
	}			
