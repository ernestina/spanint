...
//p2
$objPHPExcel->getActiveSheet()->setCellValue('B4', "Status File");
//p3
$objPHPExcel->getActiveSheet()->setCellValue('C4', "Tgl Penerimaan");
//p4
$objPHPExcel->getActiveSheet()->setCellValue('D4', "Kode Bank");
//p5
$objPHPExcel->getActiveSheet()->setCellValue('E4', "No. Rek. Persepsi");
//p6
$objPHPExcel->getActiveSheet()->setCellValue('F4', "Jumlah Rupiah");
//p7
$objPHPExcel->getActiveSheet()->setCellValue('G4', "Nomor Batch");
//p8
$objPHPExcel->getActiveSheet()->setCellValue('H4', "Nama File");
...
if (count($this->data) == 0) {
	...
	$nil['p4']=$value->get_bank_code();
	$nil['p5']=$value->get_bank_account_num();
	if ($value->get_keterangan()==0){
		$nil['p6']='0';
	}else{
		$nil['p6']=$value->get_keterangan();
	}
	$nil['p7']=$value->get_gr_batch_num();
	$nil['p8']=$value->get_file_name();
