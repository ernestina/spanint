...
class FPDF_AutoWrapTable extends FPDF {
    ...
    public function rptDetailData() {
        ...
        $ukuran_kolom_jenis_belanja = 150;
        ...
        $py2 = $py1;
        $this->SetXY($px2, $py2);
        $this->Cell($ukuran_kolom_tgl_sp2d, $h, 'Satker', 1, 0, 'C', true);
        $this->SetX($px2 += $ukuran_kolom_tgl_sp2d);
        $this->Cell($ukuran_kolom_satker, $h, 'KPPN', 1, 0, 'C', true);
...
//--------------------------
//pilihan
$judul = 'Laporan Detail CoA Penerimaan'; //judul file laporan
$tipefile = '.pdf';
