...
//-----------------------------
	IF(isset($this->d_nama_kppn) || isset($this->d_kd_satker) || isset($this->d_sumber_dana)){
		...
		?>
		<a href="<?php echo URL; ?>PDF/KarwasUPSatker_PDF/<?php echo $kdkppn . "/" . $kdsatker . "/" . $kdsmbdana; ?>" style="width: 100%" class="btn btn-default"><span class="glyphicon glyphicon-print"></span> PDF</a>
		<?php
		}
	//------------------------------
}
