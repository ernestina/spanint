...
class FPDF_AutoWrapTable extends FPDF {
    ...
    public function rptDetailData() {
		...
		$ukuran_kolom_dana1 = 120;
		$ukuran_kolom_dana2 = 30;
		$ukuran_kolom_dana3 = 50;
        ...
        $this->Cell($ukuran_kolom_dana4, $h, 'Tanggal Invoice', 1, 0, 'C', true);
        $this->SetX($left += $ukuran_kolom_dana4);
		$this->Cell($ukuran_kolom_dana4, $h, 'Tanggal Konversi', 1, 0, 'C', true);
        $this->SetX($left += $ukuran_kolom_dana4);
		$this->Cell($ukuran_kolom_dana, $h, 'Nilai Invoice', 1, 0, 'C', true);
        $this->SetX($left += $ukuran_kolom_dana);
        ...
        $this->Cell($ukuran_kolom_akun, $h, 'Nama File ZIP', 1, 0, 'C', true);
        $px1 = $this->GetX();
        $this->SetX($left += $ukuran_kolom_akun);
        $py1 = $this->GetY();
        $px2 = $px1;
        ...
        $this->SetWidths(array($kolom1,$ukuran_kolom_dana2,
		$ukuran_kolom_dana3,$ukuran_kolom_dana,$ukuran_kolom_dana4,
		$ukuran_kolom_dana4,$ukuran_kolom_dana,
		$ukuran_kolom_dana1,$ukuran_kolom_akun,
                ...
                $this->Row(
                        array($no++,
							...
							$value->get_invoice_date(),
							 strtoupper ($value->get_conversion_date()),
							 number_format($value->get_invoice_amount()),
							 $value->get_jendok(),
							 $value->get_file_name(),
							 $value->get_file_name_zip(),
							 $value->get_durasi(). "   (hari)"
							)
...
//--------------------------
//pilihan
$judul = 'Daftar Invoice Hasil Konversi Yang Belum Diproses di SPAN'; //judul file laporan
$tipefile = '.pdf';
