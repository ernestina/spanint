...
class FPDF_AutoWrapTable extends FPDF {
    ...
    public function rptDetailData() {
		...
		$kolom_grandtotal1=30+80+$ukuran_kolom_jenis_belanja+
		$ukuran_kolom_satker+$ukuran_kolom_satker;
		$kolom_grandtotal2=$ukuran_kolom_bank_pembayar+$ukuran_kolom_norek_penerima+
        ...
        $this->SetX($left += 30);
        $this->Cell(80, $h, 'Tgl Selesai SP2D', 1, 0, 'C', true);
        $px1 = $this->GetX();
        $this->SetX($left += 80);
        $py1 = $this->GetY();
        $px2 = $px1;
        ...
        $this->Cell($ukuran_kolom_satker, $h, 'No. Invoice', 1, 0, 'C', true);
        $this->SetX($px2 += $ukuran_kolom_satker);
        ...
        $this->Cell($ukuran_kolom_norek_penerima, $h, 'Bank Penerima', 1, 0, 'C', true);
        ...
        $this->SetWidths(array(
            ...
            $ukuran_kolom_satker, $ukuran_kolom_jenis_belanja,
            $ukuran_kolom_bank_pembayar, $ukuran_kolom_norek_penerima,
            $ukuran_kolom_jenis_belanja, $ukuran_kolom_norek_penerima,
            $ukuran_kolom_dana, $ukuran_kolom_jenis_belanja,
            $ukuran_kolom_dana, $ukuran_kolom_jenis_belanja
        ));
        $this->SetAligns(array('C', 'C', 'C', 'C', 'C', 'R', 'L', 'L', 'L', 'C', 'L', 'R'));
...
//--------------------------
//pilihan
$judul = 'Laporan Monitoring SP2D-BANK'; //judul file laporan
$tipefile = '.pdf';
