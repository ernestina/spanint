...
//p7
$objPHPExcel->getActiveSheet()->setCellValue('G4', "Deskripsi");
//p8
$objPHPExcel->getActiveSheet()->setCellValue('H4', "Nomor Sp2d");
//p9
$objPHPExcel->getActiveSheet()->setCellValue('I4', "Tanggal Sp2d");
//p10
$objPHPExcel->getActiveSheet()->setCellValue('J4', "Jumlah");
...
if (count($this->data) == 0) {
	...
	$no++;
	$nil['p1']=$no;
	$nil['p2']=substr($value->get_invoice_num(),7,6);
	...
	$nil['p8']=$value->get_check_num();
	$nil['p9']=$value->get_tanggal_sp2d();
