...
class FPDF_AutoWrapTable extends FPDF {
    ...
    public function rptDetailData() {
        ...
        $this->Cell($ukuran_kolom_pagu_total1, $h, 'Tanggal Invoice', 1, 0, 'C', true);
        $this->SetX($left += $ukuran_kolom_pagu_total1);
        $this->Cell($ukuran_kolom_pagu_total, $h, 'Nilai Invoice', 1, 0, 'C', true);
        $px1 = $this->GetX();
        ...
        $py2 = $py1;
        $this->SetXY($px2, $py2);
        $this->Cell($ukuran_kolom_jenis_belanja, $h, 'Uraian Invoice', 1, 0, 'C', true);
        $this->SetX($px2 += $ukuran_kolom_jenis_belanja);
        $this->Cell($ukuran_kolom_satker, $h, 'Nama File', 1, 0, 'C', true);
        $this->SetX($px2 += $ukuran_kolom_satker);
        $this->Cell($ukuran_kolom_dana, $h, 'Status Code', 1, 0, 'C', true);
        $this->SetX($px2 += $ukuran_kolom_dana);
        $this->Cell($ukuran_kolom_dana, $h, 'Supplier', 1, 0, 'C', true);
        $this->SetX($px2 += $ukuran_kolom_dana);
        $this->Cell($ukuran_kolom_dana, $h, 'Site Supplier', 1, 0, 'C', true);
        $this->SetX($px2 += $ukuran_kolom_dana);
        $this->Cell($ukuran_kolom_dana, $h, 'Nama Kolom', 1, 0, 'C', true);
        $this->SetX($px2 += $ukuran_kolom_dana);
        $this->Cell($ukuran_kolom_dana, $h, 'Nilai Kolom', 1, 0, 'C', true);
        $this->SetX($px2 += $ukuran_kolom_dana);
        $this->Cell($ukuran_kolom_deskripsi, $h, 'Error Message', 1, 1, 'C', true);
        $this->Ln(8);

        $this->SetFont('Arial', '', 7);
        $this->SetWidths(array(30, $ukuran_kolom_pagu_total_sisa,
		$ukuran_kolom_pagu_total1, $ukuran_kolom_pagu_total, 
		$ukuran_kolom_jenis_belanja, $ukuran_kolom_satker, 
		$ukuran_kolom_dana,$ukuran_kolom_dana,
		$ukuran_kolom_dana,$ukuran_kolom_dana,
		$ukuran_kolom_dana, $ukuran_kolom_deskripsi));
        ...
        foreach ($this->data as $value) {
            $this->Row(
                    array($no++,
                        ...
                        $value->get_vendor_site_code(),
                        $value->get_column_name(),
...
//--------------------------
//pilihan
$judul = 'Laporan Detail Alasan Penolakan PMRT'; //judul file laporan
$tipefile = '.pdf';
