...
if (isset($this->data)) {
    if (empty($this->data)) {
        ...
        foreach ($this->data as $value) {
            ...
            echo "<td>" . number_format($value->get_jml_spm_diterima_17()) . "</td>";
            echo "<td>" . number_format($value->get_nilai_spm_diterima_17()) . "</td>";
            echo "<td>" . number_format($value->get_jml_spm_diterbitkan_17()) . "</td>";
            echo "<td>" . number_format($value->get_nilai_spm_diterbitkan_17()) . "</td>";
            echo "<td>" . number_format($value->get_jml_spm_dlm_proses_17()) . "</td>";
            echo "<td>" . number_format($value->get_nilai_spm_dlm_proses_17()) . "</td>";
            echo "<td>" . number_format($value->get_jml_spm_diterima_18()) . "</td>";
            echo "<td>" . number_format($value->get_nilai_spm_diterima_18()) . "</td>";
            echo "<td>" . number_format($value->get_jml_spm_diterbitkan_18()) . "</td>";
            echo "<td>" . number_format($value->get_nilai_spm_diterbitkan_18()) . "</td>";
            echo "<td>" . number_format($value->get_jml_spm_dlm_proses_18()) . "</td>";
            echo "<td>" . number_format($value->get_nilai_spm_dlm_proses_18()) . "</td>";
            echo "<td>" . number_format($value->get_jml_spm_diterima_19()) . "</td>";
            echo "<td>" . number_format($value->get_nilai_spm_diterima_19()) . "</td>";
            echo "<td>" . number_format($value->get_jml_spm_diterbitkan_19()) . "</td>";
            echo "<td>" . number_format($value->get_nilai_spm_diterbitkan_19()) . "</td>";
            echo "<td>" . number_format($value->get_jml_spm_dlm_proses_19()) . "</td>";
