...
//p6
$objPHPExcel->getActiveSheet()->setCellValue('F4', "Tanggal Konversi");
//p7
$objPHPExcel->getActiveSheet()->setCellValue('G4', "Nilai Invoice");
//p8
$objPHPExcel->getActiveSheet()->setCellValue('H4', "Jenis SPM");
//p9
$objPHPExcel->getActiveSheet()->setCellValue('I4', "Nama File");
//p10
$objPHPExcel->getActiveSheet()->setCellValue('J4', "Nama File ZIP");
//p11
$objPHPExcel->getActiveSheet()->setCellValue('K4', "Durasi");
...
if (count($this->data) == 0) {
	...
	$no++;
		...
		$nil['p3']=$value->get_satker();	
		$nil['p4']=$value->get_invoice_num();
		$nil['p5']=$value->get_invoice_date();
		$nil['p6']=$value->get_conversion_date();
		if ($value->get_invoice_amount()==0){
			$nil['p7']='0';
		}else{
			$nil['p7']=$value->get_invoice_amount();
		}
		$nil['p8']=$value->get_jendok();
		$nil['p9']=$value->get_file_name();
		$nil['p10']=$value->get_file_name_zip();
		$nil['p11']=$value->get_durasi();
