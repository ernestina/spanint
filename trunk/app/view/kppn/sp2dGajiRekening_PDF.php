<?php
	...
	//File yang ditambah : sp2dGajiRekening_PDF.php
...
//-------------------------------------
	...
	$px1 = $this->GetX();
	$this->SetX($left+50); 
	$this->MultiCell(0, $h/2, 'Laporan Monitoring SP2D Gaji Terindikasi Salah PayGroup ');
	$py1 = $this->GetY();
	$px2 = $px1;
	$py2 = $py1;
	$this->SetXY($px2,$py2);
    ...
    $this->SetX($left += 30);$this->Cell($ukuran_kolom_tgl_selsp2d, $h, 'Kode Satker', 1, 0, 'C',true);
	$px1 = $this->GetX();
    ...
    $this->SetAligns(array('C','C','C','R','C','L'));
...
//--------------------------
 //Laporan Data Revisi DIPA
    //pilihan
    $options = array(
    'filename' => 'Laporan Monitoring SP2D Gaji Terindikasi Salah PayGroup.PDF', //nama file penyimpanan, kosongkan jika output ke browser
