...
//p10
$objPHPExcel->getActiveSheet()->setCellValue('J4', "Pencadangan)");
//p11
$objPHPExcel->getActiveSheet()->setCellValue('K4', "Realisasi");
//p12
$objPHPExcel->getActiveSheet()->setCellValue('L4', "Sisa Pagu");
...
if (count($this->data) == 0) {
	...
	if ($value->get_encumbrance_amt()==0){
		...
		$nil['p10']=$value->get_encumbrance_amt();
	}			
	if ($value->get_actual_amt==0){
		$nil['p11']='0';
	}else{
		$nil['p11']=$value->get_actual_amt();
	}			
	if ($value->get_balancing_amt()==0){
		$nil['p12']='0';
	}else{
		$nil['p12']=$value->get_balancing_amt();
	}			
