...
class FPDF_AutoWrapTable extends FPDF {
    ...
    function __construct($data = array(), $options = array(), $kdtgl_awal = array(), $kdtgl_akhir = array(),$nm_kppn,$nm_kppn4) {
        parent::__construct();
        $this->data = $data;
    ...
    public function rptDetailData() {
        ...
        $this->Ln(10);
        //----------------------------------------------- 
		$nm_kppn4=$this->nm_kppn4;
        #tableheader
		 //$this->MultiCell(0, $h1 / 2,'KPPN '.$nm_kppn4);
