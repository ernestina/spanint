    ...
    <div id="fitur">
        <div id="top-status-bar">
            <div>
                ...
                <div id="nav-period" style="float: right; padding-top: 3px;">Periode: <a href="<?php echo URL; ?>home/harian">Hari Ini</a><a href="<?php echo URL; ?>home/mingguan" <?php if ($this->mode == "Mingguan") {
                    echo 'class="active"';
                } ?>>7 Hari</a><a href="<?php echo URL; ?>home/bulanan" <?php if ($this->mode != "Mingguan") {
                    echo 'class="active"';
                } ?>>30 Hari</a></div>
            </div>
        </div>
