...
//p2
$objPHPExcel->getActiveSheet()->setCellValue('B4', "No. SPM");
//p3
$objPHPExcel->getActiveSheet()->setCellValue('C4', "Tgl. SPM");
//p4
$objPHPExcel->getActiveSheet()->setCellValue('D4', "No. SP2D/NTPN");
//p5
$objPHPExcel->getActiveSheet()->setCellValue('E4', "Tgl. SP2D");
//p6
$objPHPExcel->getActiveSheet()->setCellValue('F4', "Satker Pembayar");
//p7
$objPHPExcel->getActiveSheet()->setCellValue('G4', "Uraian SPM");
//p8
$objPHPExcel->getActiveSheet()->setCellValue('H4', "Atas Nama");
//p9
$objPHPExcel->getActiveSheet()->setCellValue('I4', "Setoran");
//p10
$objPHPExcel->getActiveSheet()->setCellValue('J4', "Akun");
//p11
$objPHPExcel->getActiveSheet()->setCellValue('K4', "Jumlah");
...
if (count($this->data) == 0) {
	...
	$no++;
	$nil['p1']=$no;
	$nil['p2']=$value->get_no_spm();
	$nil['p3']=$value->get_tgl_spm();
	$nil['p4']=$value->get_no_sp2d();
	$nil['p5']=$value->get_tgl_sp2d();
	$nil['p6']=$value->get_satker();
	$nil['p7']=$value->get_description();
	$nil['p8']=$value->get_nama2();
	$nil['p9']=$value->get_deskripsi_akun();
	$nil['p10']=$value->get_akun();

	if ($value->get_nilai_ori()==0){
		$nil['p11']='0';
	}else{
		$nil['p11']=$value->get_nilai_ori();
	}		
