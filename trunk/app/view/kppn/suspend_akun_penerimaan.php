            ...
            <div class="btn-group-sm">
                <button type="button" class="btn btn-default dropdown-toggle fullwidth" data-toggle="dropdown" aria-expanded="false"><span class="glyphicon glyphicon-print"></span>&nbsp; Cetak <span class="caret"></span>
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="<?php echo URL; ?>PDF/SuspendAkunPenerimaan_PDF/<?php echo $kdtgl_awal . "/" . $kdtgl_akhir . "/" . $kdkppn . "/" . $kdkoreksi; ?>/PDF">PDF</a></li>
                        <li><a href="<?php echo URL; ?>PDF/SuspendAkunPenerimaan_PDF/<?php echo $kdtgl_awal . "/" . $kdtgl_akhir . "/" . $kdkppn . "/" . $kdkoreksi; ?>/XLS">EXCEL</a></li>
                      </ul>
            </div>
