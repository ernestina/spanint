    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-1 col-md-3 col-sm-12" style="padding-top: 10px;">
			 <?php
			//----------------------------------------------------
			//Development History.Revisi : 0 Kegiatan :1.mencetak hasil filter ke dalam pdf Dibuat oleh : Rifan Abdul Rachman Tanggal dibuat : 18-07-2014  File yang diubah : suspend_akun_penerimaan.php  
			...
			?>
			<a href="<?php echo URL; ?>PDF/SuspendAkunPenerimaan_PDF/<?php echo $kdtgl_awal . "/" . $kdtgl_akhir . "/" . $kdkppn . "/" . $kdkoreksi; ?>/PDF" style="width: 100%" class="btn btn-default"><span class="glyphicon glyphicon-print"></span> PDF</a>
			</div><div class="col-lg-1 col-md-3 col-sm-12" style="padding-top: 10px;">
			<a href="<?php echo URL; ?>PDF/SuspendAkunPenerimaan_PDF/<?php echo $kdtgl_awal . "/" . $kdtgl_akhir . "/" . $kdkppn . "/" . $kdkoreksi; ?>/XLS" style="width: 100%" class="btn btn-default"><span class="glyphicon glyphicon-print-xls"></span> XLS</a>
