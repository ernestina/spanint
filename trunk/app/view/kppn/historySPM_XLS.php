...
//p3
$objPHPExcel->getActiveSheet()->setCellValue('C4', "Response");
//p4
$objPHPExcel->getActiveSheet()->setCellValue('D4', "Nama User");
//p5
$objPHPExcel->getActiveSheet()->setCellValue('E4', "Waktu Mulai");
//p6
...
if (count($this->data) == 0) {
	...
	$nil['p3']=$value->get_response();
	$nil['p4']=$value->get_user_name();
	$nil['p5']=$value->get_creation_date();
	$nil['p6']=$value->get_check_number();
