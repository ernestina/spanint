...
?>
                    ...
                    <input type="text" name="invoice" id="invoice" value="<?php if (isset($this->d_invoice)) {
                        echo $this->d_invoice;
                    } ?>">
...
?>
                    ...
                    <select type="text" name="status" id="status">
                        <option value=''>- pilih -</option>
                        <option value='SUKSES' <?php if ($this->d_status == SUKSES) {
    echo "selected";
} ?>>SUKSES</option>
                        <option value='TIDAK' <?php if ($this->d_status == TIDAK) {
        echo "selected";
    } ?>>TIDAK SUKSES</option>
        ...
        echo "selected";
                    ...
                    <select type="text" name="bayar" id="bayar">
                        <option value=''>- pilih -</option>
                        <option value='OVERBOOKING' <?php if ($this->d_bayar == OVERBOOKING) {
        echo "selected";
    } ?>>OVERBOOKING</option>
                        <option value='SKN' <?php if ($this->d_bayar == SKN) {
        echo "selected";
    } ?>>SKN</option>
                        <option value='RTGS' <?php if ($this->d_bayar == RTGS) {
        echo "selected";
    } ?>>RTGS</option>
                        <option value='SWIFT' <?php if ($this->d_bayar == SWIFT) {
        echo "selected";
    } ?>>SWIFT</option>
                        <option value='SEMUA' <?php if ($this->d_bayar == SEMUA) {
                    echo "selected";
                } ?>>SEMUA</option>
                    </select>
