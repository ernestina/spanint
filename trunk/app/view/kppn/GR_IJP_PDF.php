...
//-------------------------------------
	...
	$px1 = $this->GetX();
	$this->SetX($left+50); 
	$this->MultiCell(0, $h/2, 'Laporan Monitoring Imbalan Jasa Perbankan');
	$py1 = $this->GetY();
	$px2 = $px1;
	$py2 = $py1;
	$this->SetXY($px2,$py2);
    ...
    $this->SetX($left += 20); $this->Cell(60, $h, 'Bank Cabang', 1, 0, 'C',true);  
	$this->SetX($left += 60); $this->Cell(60, $h, 'No.Rekening', 1, 0, 'C',true);
	$px1 = $this->GetX();
	$this->SetX($left += 60); $this->Cell(620, $h/2, 'Tanggal Penerimaan', 1, 0, 'C',true);
	$py1 = $this->GetY();
	$px2 = $px1;
	$py2 = $py1+20;
	$this->SetXY($px2,$py2);
    ...
    $this->SetAligns(array('C','L','L','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R'));
    $no = 1; 
	...
	$py3 = $this->GetY();
    $this->SetX($left += 620); $this->Cell($ukuran_kolom_pagu_total_sisa, $h, number_format($jtotal), 1, 1, 'R',true);
	$this->Ln(3);  
    }
...
//--------------------------
    //pilihan
    $options = array(
    'filename' => 'Laporan Monitoring Imbalan Jasa Perbankan.PDF', //nama file penyimpanan, kosongkan jika output ke browser
