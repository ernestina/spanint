    ...
    <div class="container-fluid">
        ...
        <div class="btn-group-sm">
            <button type="button" class="btn btn-default dropdown-toggle fullwidth" data-toggle="dropdown" aria-expanded="false"><span class="glyphicon glyphicon-print"></span>&nbsp; Cetak <span class="caret"></span>
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="<?php echo URL; ?>PDF/DaftarSP3_PDF/<?php echo $bulan . "/" . $satker . "/" . $kdkppn . "/" . $kdsatker; ?>/PDF">PDF</a></li>
                    <li><a href="<?php echo URL; ?>PDF/DaftarSP3_PDF/<?php echo $bulan . "/" . $satker . "/" . $kdkppn . "/" . $kdsatker; ?>/XLS">EXCEL</a></li>
                  </ul>
        </div>
				<?php
				//----------------------------------
        ...
        <div class="row" style="padding-top: 10px">
             <div class="col-md-6 col-sm-12">
                ...
                ?>
				<br>
				 Bulan : <?php echo Tanggal::bulan_indo($this->bulan); ?>
                <br>Tanggal : s.d <?php
                echo (date('d-m-Y'));
                ?>
            </div>             
            ...
            if (isset($this->data)) {
                if (empty($this->data)) {
                    ...
                    foreach ($this->data as $value) {
						...
						echo "<td class='ratakanan'>" . number_format($value->get_pendapatan()) . "</td>";
						echo "<td class='ratakanan'>" . number_format($value->get_belanja()) . "</td>";						
                        echo "</tr>	";
                    }
                }
            } else {
