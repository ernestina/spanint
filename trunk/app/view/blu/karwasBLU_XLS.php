...
//p5
$objPHPExcel->getActiveSheet()->setCellValue('E4', "KPPN");
//p6
$objPHPExcel->getActiveSheet()->setCellValue('F4', "Jan");
//p7
$objPHPExcel->getActiveSheet()->setCellValue('G4', "Feb");
//p8
$objPHPExcel->getActiveSheet()->setCellValue('H4', "Mar");
//p9
$objPHPExcel->getActiveSheet()->setCellValue('I4', "Apr");
//p10
$objPHPExcel->getActiveSheet()->setCellValue('J4', "Mei");
//p11
$objPHPExcel->getActiveSheet()->setCellValue('K4', "Jun");
//p12
$objPHPExcel->getActiveSheet()->setCellValue('L4', "Jul");
//p13
$objPHPExcel->getActiveSheet()->setCellValue('M4', "Agu");
//p14
$objPHPExcel->getActiveSheet()->setCellValue('N4', "Sep");
//p15
$objPHPExcel->getActiveSheet()->setCellValue('O4', "Okt");
//p16
$objPHPExcel->getActiveSheet()->setCellValue('P4', "Nov");
//p17
$objPHPExcel->getActiveSheet()->setCellValue('Q4', "Des");
//p18
...
if (count($this->data) == 0) {
	...
	$nil['p4']=$value->get_rumpun();
	$nil['p5']=$value->get_kppn();
	$nil['p6']=$value->get_januari();
	$nil['p7']=$value->get_februari();
	$nil['p8']=$value->get_maret();
	$nil['p9']=$value->get_april();
	$nil['p10']=$value->get_mei();
	$nil['p11']=$value->get_juni();
	$nil['p12']=$value->get_juli();
	$nil['p13']=$value->get_agustus();
	$nil['p14']=$value->get_september();
	$nil['p15']=$value->get_oktober();
	$nil['p16']=$value->get_november();
	$nil['p17']=$value->get_desember();
	$nil['p18']=$value->get_januari()+$value->get_februari()+$value->get_maret()+$value->get_april()+$value->get_mei()+$value->get_juni()+
...
$objPHPExcel->getActiveSheet()->getStyle('E5:E1000')->getNumberFormat()->setFormatCode('000');
