...
class FPDF_AutoWrapTable extends FPDF {
    ...
    public function rptDetailData() {
		...
		$ukuran_kolom_dana1 = 128;
		$ukuran_kolom_dana2 = 40;
		...
		$this->Cell($ukuran_kolom_dana3, $h, 'Satker', 1, 0, 'C', true);
        $this->SetX($left += $ukuran_kolom_dana3);
        $this->Cell($ukuran_kolom_dana1, $h, 'Nama Satker', 1, 0, 'C', true);
        $this->SetX($left += $ukuran_kolom_dana1);
        $this->Cell($ukuran_kolom_dana, $h, 'Rumpun', 1, 0, 'C', true);
        $this->SetX($left += $ukuran_kolom_dana);
        $this->Cell($ukuran_kolom_dana2, $h, 'KPPN', 1, 0, 'C', true);
        $this->SetX($left += $ukuran_kolom_dana2);
		$this->Cell($ukuran_kolom_dana2, $h, 'Jan', 1, 0, 'C', true);
        $this->SetX($left += $ukuran_kolom_dana2);
		$this->Cell($ukuran_kolom_dana2, $h, 'Feb', 1, 0, 'C', true);
        $this->SetX($left += $ukuran_kolom_dana2);
		$this->Cell($ukuran_kolom_dana2, $h, 'Mar', 1, 0, 'C', true);
        $this->SetX($left += $ukuran_kolom_dana2);
		$this->Cell($ukuran_kolom_dana2, $h, 'Apr', 1, 0, 'C', true);
        $this->SetX($left += $ukuran_kolom_dana2);
		$this->Cell($ukuran_kolom_dana2, $h, 'Mei', 1, 0, 'C', true);
        $this->SetX($left += $ukuran_kolom_dana2);
		$this->Cell($ukuran_kolom_dana2, $h, 'Jun', 1, 0, 'C', true);
        $this->SetX($left += $ukuran_kolom_dana2);
        $this->Cell($ukuran_kolom_dana2, $h, 'Jul', 1, 0, 'C', true);
        $this->SetX($left += $ukuran_kolom_dana2);
        $this->Cell($ukuran_kolom_dana2, $h, 'Agu', 1, 0, 'C', true);
        $this->SetX($left += $ukuran_kolom_dana2);
        $this->Cell($ukuran_kolom_dana2, $h, 'Sep', 1, 0, 'C', true);
        $this->SetX($left += $ukuran_kolom_dana2);
        $this->Cell($ukuran_kolom_dana2, $h, 'Okt', 1, 0, 'C', true);
        $this->SetX($left += $ukuran_kolom_dana2);
        $this->Cell($ukuran_kolom_dana2, $h, 'Nov', 1, 0, 'C', true);
        $this->SetX($left += $ukuran_kolom_dana2);
        $this->Cell($ukuran_kolom_dana2, $h, 'Des', 1, 0, 'C', true);
        $px1 = $this->GetX();
        $this->SetX($left += $ukuran_kolom_dana2);
        $py1 = $this->GetY();
        $px2 = $px1;
        $py2 = $py1;
        $this->SetXY($px2, $py2);
        $this->Cell($ukuran_kolom_dana3, $h, 'Total', 1, 1, 'C', true);
        $this->SetX($px2 += $ukuran_kolom_dana3);
        $this->Ln(8);
		...
		$ukuran_kolom_dana2,$ukuran_kolom_dana2,
		$ukuran_kolom_dana2,$ukuran_kolom_dana2,
		$ukuran_kolom_dana2,$ukuran_kolom_dana3));
            ...
            foreach ($this->data as $value) {
                $this->Row(
                        array($no++,
							...
							$value->get_november(),
							$value->get_desember(),
						$value->get_januari()+$value->get_februari()+$value->get_maret()+$value->get_april()+$value->get_mei()+$value->get_juni()+
...
//--------------------------
//pilihan
$judul = 'Daftar Monitoring SP3 BLU Per Tahun'; //judul file laporan
$tipefile = '.pdf';
