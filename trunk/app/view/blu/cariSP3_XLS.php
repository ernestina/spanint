...
//p3
$objPHPExcel->getActiveSheet()->setCellValue('C4', "No SP3B");
//p4
$objPHPExcel->getActiveSheet()->setCellValue('D4', "Tanggal SP3B");
//p5
$objPHPExcel->getActiveSheet()->setCellValue('E4', "Nomor SP2B");
//p6
$objPHPExcel->getActiveSheet()->setCellValue('F4', "Tanggal SP2B");
//p7
$objPHPExcel->getActiveSheet()->setCellValue('G4', "Nilai SP2B");
//p8
$objPHPExcel->getActiveSheet()->setCellValue('H4', "Akun");
//p9
$objPHPExcel->getActiveSheet()->setCellValue('I4', "Program");
//p10
$objPHPExcel->getActiveSheet()->setCellValue('J4', "Output");
//p11
$objPHPExcel->getActiveSheet()->setCellValue('K4', "Penerimaan");
//p12
$objPHPExcel->getActiveSheet()->setCellValue('L4', "Pengeluaran");
...
if (count($this->data) == 0) {
	...
	$nil['p4']=$value->get_invoice_date();
	$nil['p5']=$value->get_check_number();
	$nil['p6']=$value->get_check_date();
	if ($value->get_check_amount()==0){
		$nil['p7']='0';
	}else{
		$nil['p7']=$value->get_check_amount();
	}			
	$nil['p8']=$value->get_akun();
	$nil['p9']=$value->get_program();
	$nil['p10']=$value->get_output();
	if ($value->get_pendapatan()==0){
		$nil['p11']='0';
	}else{
		$nil['p11']=$value->get_pendapatan();
	}
	if ($value->get_belanja()==0){
		$nil['p12']='0';
	}else{
		$nil['p12']=$value->get_belanja();
	}	
