        ...
        <div class="row">
            ...
            <button type="button" class="btn btn-default dropdown-toggle fullwidth" data-toggle="dropdown" aria-expanded="false"><span class="glyphicon glyphicon-print"></span>&nbsp; Cetak <span class="caret"></span>
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="<?php echo URL; ?>PDF/DataRealisasiBelanjaBLU_PDF/<?php echo $kdsatker . "/" . $kdsumberdana . "/" . $kdrumpun; ?>/PDF">PDF</a></li>
                    <li><a href="<?php echo URL; ?>PDF/DataRealisasiBelanjaBLU_PDF/<?php echo $kdsatker . "/" . $kdsumberdana . "/" . $kdrumpun; ?>/XLS">EXCEL</a></li>
                  </ul>
            </div>
