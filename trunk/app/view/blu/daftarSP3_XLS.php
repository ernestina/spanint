...
//p2
$objPHPExcel->getActiveSheet()->setCellValue('B4', "No SP3B");
//p3
$objPHPExcel->getActiveSheet()->setCellValue('C4', "Tanggal SP3B");
//p4
$objPHPExcel->getActiveSheet()->setCellValue('D4', "Nomor SP2B");
//p5
$objPHPExcel->getActiveSheet()->setCellValue('E4', "Tanggal SP2B");
//p6
$objPHPExcel->getActiveSheet()->setCellValue('F4', "Nilai SP2B");
//p7
$objPHPExcel->getActiveSheet()->setCellValue('G4', "Penerimaan");
//p8
$objPHPExcel->getActiveSheet()->setCellValue('H4', "Pengeluaran");
...
if (count($this->data) == 0) {
	...
	if ($value->get_pendapatan()==0){
		...
		$nil['p7']=$value->get_pendapatan();
	}
	if ($value->get_belanja()==0){
		$nil['p8']='0';
	}else{
		$nil['p8']=$value->get_belanja();
	}	
