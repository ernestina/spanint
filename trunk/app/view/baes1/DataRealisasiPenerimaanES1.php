    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-10 col-md-6 col-sm-12">
                <h2>Realisasi Pendapatan Per <?php if(Session::get('role') == MENKEU) {?> Kementerian/Lembaga <?php } else { ?>Eselon 1 <?php } ?></h2>
            </div>
            ...
            <div class="btn-group-sm">
                <button type="button" class="btn btn-default dropdown-toggle fullwidth" data-toggle="dropdown" aria-expanded="false"><span class="glyphicon glyphicon-print"></span>&nbsp; Cetak <span class="caret"></span>
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="<?php echo URL; ?>PDF/DataRealisasiPenerimaanPerES1_BAES1_PDF/<?php echo $kdlokasi; ?>/PDF">PDF</a></li>
                        <li><a href="<?php echo URL; ?>PDF/DataRealisasiPenerimaanPerES1_BAES1_PDF/<?php echo $kdlokasi; ?>/XLS">EXCEL</a></li>
                      </ul>
            </div>
